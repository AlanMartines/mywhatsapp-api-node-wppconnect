(function(self) {
  ...
  if (ENVIRONMENT_IS_NODE) {
    if (!Module["print"]) Module["print"] = function e(e) {
      process["stdout"].write(e + "\n")
    };
    if (!Module["printErr"]) Module["printErr"] = function r(e) {
    ...
    if (typeof console !== "undefined") {
      if (!Module["print"]) Module["print"] = function f(e) {
        console.log(e)
      };
      if (!Module["printErr"]) Module["printErr"] = function l(e) {
        console.log(e)
      }
    } else {
  ...
  function setValue(e, r, i, t) {
    ...
    switch (i) {
      ...
      case "i32":
        ...
        break;
      case "i64":
        tempI64 = [r >>> 0, (tempDouble = r, +Math_abs(tempDouble) >= +1 ? tempDouble > +0 ? (Math_min(+Math_floor(tempDouble / +4294967296), +4294967295) | 0) >>> 0 : ~~+Math_ceil((tempDouble - +(~~tempDouble >>> 0)) / +4294967296) >>> 0 : 0)], HEAP32[e >> 2] = tempI64[0], HEAP32[e + 4 >> 2] = tempI64[1];
        break;
      case "float":
        HEAPF32[e >> 2] = r;
        break;
  ...
  if (!Math["imul"] || Math["imul"](4294967295, 5) !== -5) Math["imul"] = function c(e, r) {
    var n = e >>> 16;
    var i = e & 65535;
    var o = r >>> 16;
    var t = r & 65535;
  ...
  Math.imul = Math["imul"];
  if (!Math["clz32"]) Math["clz32"] = function(r) {
    r = r >>> 0;
    for (var e = 0; e < 32; e++) {
  ...
  var IDBFS = {
    ...
    reconcile: function(i, r, n) {
      ...
      s.sort().reverse().forEach(function(i) {
        if (r.type === "local") {
  ...
  var FS = {
    ...
    lookupPath: function(a, e) {
      ...
      var n = PATH.normalizeArray(a.split("/").filter(function(e) {
        return !!e
      }), false);
      var r = FS.root;
      var i = "/";
    ...
    createPreloadedFile: function(r, o, i, d, c, a, e, l, u, s) {
      ...
      addRunDependency(t);
      if (typeof i == "string") {
        Browser.asyncLoad(i, function(e) {
          f(e)
        }, e)
      } else {
        f(i)
  ...
  var Browser = {
    ...
    requestFullScreen: function(n, o, t) {
      ...
      function i() {
        ...
        var r = e.parentNode;
        if ((document["webkitFullScreenElement"] || document["webkitFullscreenElement"] || document["mozFullScreenElement"] || document["mozFullscreenElement"] || document["fullScreenElement"] || document["fullscreenElement"] || document["msFullScreenElement"] || document["msFullscreenElement"] || document["webkitCurrentFullScreenElement"]) === r) {
      ...
      r.appendChild(e);
      r.requestFullScreen = r["requestFullScreen"] || r["mozRequestFullScreen"] || r["msRequestFullscreen"] || (r["webkitRequestFullScreen"] ? function() {
    ...
    websocket_sock_ops: {
      createPeer: function(t, r, n) {
        ...
        if (t.type === 2 && typeof t.sport !== "undefined") {
          a.dgram_send_queue.push(new Uint8Array([255, 255, 255, 255, "p".charCodeAt(0), "o".charCodeAt(0), "r".charCodeAt(0), "t".charCodeAt(0), (t.sport & 65280) >> 8, t.sport & 255]))
        }
        return a
      },
      ...
      handlePeerEvents: function(r, e) {
        ...
        function n(t) {
          ...
          var n = i;
          i = false;
          if (n && t.length === 10 && t[0] === 255 && t[1] === 255 && t[2] === 255 && t[3] === 255 && t[4] === "p".charCodeAt(0) && t[5] === "o".charCodeAt(0) && t[6] === "r".charCodeAt(0) && t[7] === "t".charCodeAt(0)) {
            var o = t[8] << 8 | t[9];
        ...
        if (ENVIRONMENT_IS_NODE) {
          ...
          e.socket.on("error", function(e) {
            ...
            Module["websocket"].emit("error", [r.stream.fd, r.error, "ECONNREFUSED: Connection refused"])
          })
        } else {
          e.socket.onopen = t;
      ...
      poll: function(r) {
        ...
        if (r.recv_queue.length || !e || e && e.socket.readyState === e.socket.CLOSING || e && e.socket.readyState === e.socket.CLOSED) {
          i |= 64 | 1
        }
      ...
      sendmsg: function(r, i, o, a, t, n) {
        ...
        if (r.type === 1) {
          if (!e || e.socket.readyState === e.socket.CLOSING || e.socket.readyState === e.socket.CLOSED) {
            throw new FS.ErrnoError(ERRNO_CODES.ENOTCONN)
      ...
      recvmsg: function(r, s) {
        ...
        if (!e) {
          if (r.type === 1) {
            ...
            if (!i) {
              throw new FS.ErrnoError(ERRNO_CODES.ENOTCONN)
            } else if (i.socket.readyState === i.socket.CLOSING || i.socket.readyState === i.socket.CLOSED) {
              return null
            } else {
              throw new FS.ErrnoError(ERRNO_CODES.EAGAIN)
            }
  ...
  function __formatString(C, p) {
    ...
    function c(e) {
      ...
      if (e === "double") {
        r = (HEAP32[tempDoublePtr >> 2] = HEAP32[p + l >> 2], HEAP32[tempDoublePtr + 4 >> 2] = HEAP32[p + (l + 4) >> 2], +HEAPF64[tempDoublePtr >> 3]);
        l += 8
      } else if (e == "i64") {
      ...
      if (S == 37) {
        ...
        case "G": {
          ...
          if (isNaN(i)) {
            ...
            var f = e.split("e");
            if (A && !v) {
              while (f[0].length > 1 && f[0].indexOf(".") != -1 && (f[0].slice(-1) == "0" || f[0].slice(-1) == ".")) {
                f[0] = f[0].slice(0, -1)
              }
            } else {
  ...
  var asm = function(E, u, C) {
    ...
    function ei(E, se, V, te, fe, Be, Ce, Y, ae) {
      ...
      if ((_ | 0) > 0)
        if ((D | 0) > 2) {
          ...
          do {
            ...
            w = 0;
            do {
              r[O + (u * 2304 | 0) + (w << 2) >> 2] = +r[n + (w + 407 << 2) >> 2] - (+r[n + (w + 418 << 2) >> 2] + +r[n + (w + 397 << 2) >> 2]) * 1.7303260184043527e-17 - (+r[n + (w + 417 << 2) >> 2] + +r[n + (w + 398 << 2) >> 2]) * .017031719908118248 - (+r[n + (w + 416 << 2) >> 2] + +r[n + (w + 399 << 2) >> 2]) * 1.3495279640235235e-17 + (+r[n + (w + 415 << 2) >> 2] + +r[n + (w + 400 << 2) >> 2]) * .04180720075964928 - (+r[n + (w + 414 << 2) >> 2] + +r[n + (w + 401 << 2) >> 2]) * 6.732779685849225e-17 - (+r[n + (w + 413 << 2) >> 2] + +r[n + (w + 402 << 2) >> 2]) * .08763240277767181 - (+r[n + (w + 412 << 2) >> 2] + +r[n + (w + 403 << 2) >> 2]) * 3.0835000291318875e-17 + (+r[n + (w + 411 << 2) >> 2] + +r[n + (w + 404 << 2) >> 2]) * .1863476037979126 - (+r[n + (w + 410 << 2) >> 2] + +r[n + (w + 405 << 2) >> 2]) * 1.1044240253100168e-16 - (+r[n + (w + 409 << 2) >> 2] + +r[n + (w + 406 << 2) >> 2]) * .6276379823684692;
              w = w + 1 | 0
            } while ((w | 0) != 576);
            l(te + (V * 976 | 0) + (u * 488 | 0) + 244 | 0, E + 26636 + (u * 244 | 0) | 0, 244) | 0;
            l(te + (V * 976 | 0) + (u * 488 | 0) | 0, E + 25660 + (u * 244 | 0) | 0, 244) | 0;
            F = u + 2 | 0;
            l(fe + (V * 976 | 0) + (u * 488 | 0) + 244 | 0, E + 26636 + (F * 244 | 0) | 0, 244) | 0;
            l(fe + (V * 976 | 0) + (u * 488 | 0) | 0, E + 25660 + (F * 244 | 0) | 0, 244) | 0;
            u = u + 1 | 0
          } while ((u | 0) != (_ | 0))
        } else {
          u = 0;
        ...
        do {
          ...
          do {
            n = z + (M << 4) + (((u | 0) / 3 | 0) << 2) | 0;
            if ((e[n >> 2] | 0) == 0 ? +r[S + (u << 2) >> 2] > a : 0) e[n >> 2] = ((u | 0) % 3 | 0) + 1;
            u = u + 1 | 0
          } while ((u | 0) != 12);
          u = z + (M << 4) | 0;
          h = +r[H >> 2];
          ...
          s = +r[pe >> 2];
          if (s < h & (a < s * 1.7000000476837158 ? (a > s ? a : s) < 4e4 : 0)) e[z + (M << 4) + 12 >> 2] = 0;
          n = e[u >> 2] | 0;
          _ = e[E + 27780 + (M << 2) >> 2] | 0;
          if ((n | 0) <= (_ | 0)) {
            e[u >> 2] = 0;
          ...
          w = z + (M << 4) + 4 | 0;
          u = e[w >> 2] | 0;
          if ((_ | 0) != 3 ? (u + n + (e[z + (M << 4) + 8 >> 2] | 0) | 0) == (0 - (e[z + (M << 4) + 12 >> 2] | 0) | 0) : 0) n = 1;
          else x = 47;
          do
            if ((x | 0) == 47) {
              x = 0;
      ...
      if (ee) {
        ...
        do {
          ...
          if (!_) {
            if ((R | 0) == 2) {
              ...
              while (1) {
                ...
                F = re + (n << 12) + (w << 2) | 0;
                s = +r[F >> 2];
                r[$ >> 2] = (s + m) * .7071067690849304;
                r[F >> 2] = (m - s) * .7071067690849304;
                if ((w | 0) > 0) w = w + -1 | 0;
                else break
              }
            }
          ...
          if (a > 0) {
            s = +r[S >> 2];
            m = +r[D >> 2];
            n = ~~(((s < m ? m : s) * 2 - a) * 20 / (+((e[g + 1716 >> 2] | 0) + -1 + (e[g + 1720 >> 2] | 0) | 0) * a));
            n = (n | 0) > 8 ? 8 : n & 255
          } else n = 0;
          i[O >> 0] = n;
          v = A + -1 | 0;
          ...
          if ((v | 0) > 1) {
            ...
            while (1) {
              ...
              if (a > 0) {
                ...
                s = s < L ? L : s;
                L = +r[S + (u << 2) >> 2];
                n = ~~(((s < L ? L : s) * 3 - a) * 20 / (+((e[g + 1716 + (n << 2) >> 2] | 0) + -1 + (e[g + 1716 + (w << 2) >> 2] | 0) + (e[g + 1716 + (u << 2) >> 2] | 0) | 0) * a));
                n = (n | 0) > 8 ? 8 : n & 255
              } else n = 0;
              i[O + w >> 0] = n;
              a = m + h;
          ...
          if (a > 0) {
            s = +r[S + (n << 2) >> 2];
            m = +r[S + (u << 2) >> 2];
            n = ~~(((s < m ? m : s) * 2 - a) * 20 / (+((e[g + 1716 + (n << 2) >> 2] | 0) + -1 + (e[g + 1716 + (u << 2) >> 2] | 0) | 0) * a));
            n = (n | 0) > 8 ? 8 : n & 255
          } else n = 0;
          i[O + u >> 0] = n;
          if (B) {
            ...
            do {
              ...
              u = o[O + T >> 0] | 0;
              _ = e[W >> 2] | 0;
              a = +r[U + (R << 8) + (T << 2) >> 2] * +r[_ + (w << 2) >> 2] * +r[11488 + (u << 2) >> 2];
              w = w + 1 | 0;
              if ((T | 0) < (y | 0)) {
                B = w;
                v = T;
                while (1) {
                  ...
                  A = o[O + v >> 0] | 0;
                  u = A + u | 0;
                  h = +r[U + (R << 8) + (v << 2) >> 2] * +r[_ + (B << 2) >> 2] * +r[11488 + (A << 2) >> 2];
                  A = v - n | 0;
                  a = a < 0 ? 0 : a;
                  h = h < 0 ? 0 : h;
                  do
              ...
              m = +r[11488 + (((u << 1 | 1 | 0) / (_ << 1 | 0) | 0) << 2) >> 2] * .5;
              h = m * a;
              u = e[j >> 2] | 0;
              do
                if ((u | 0) == 2) {
      ...
      if ((e[ve >> 2] | 0) == 1 ? ((e[q + 4 >> 2] | 0) + (e[q >> 2] | 0) | 0) == 2 : 0) ur(U, K, k + 768 | 0, (e[E + 85796 >> 2] | 0) + 212 | 0, N, +r[be >> 2], e[k + 2148 >> 2] | 0);
      if (ee) {
        _ = 0;
        do {
          F = U + (_ << 8) | 0;
          v = K + (_ << 8) | 0;
          Ae(e[Z >> 2] | 0, F, v, E + 26636 + (_ * 244 | 0) | 0, E + 25660 + (_ * 244 | 0) | 0);
      ...
      do {
            ...
            if (le | (e[q + (w << 2) >> 2] | 0) == 0) {
              ...
              if ((D | 0) == 2) {
                ...
                while (1) {
                  ...
                  s = +r[g >> 2];
                  r[Y >> 2] = (s + m) * .7071067690849304;
                  r[g >> 2] = (m - s) * .7071067690849304;
                  if ((u | 0) > 0) u = u + -1 | 0;
                  else break
                }
              }
              ...
              if (a > 0) {
                s = +r[S >> 2];
                L = +r[Ie >> 2];
                n = ~~(((s < L ? L : s) * 2 - a) * 20 / (+((e[g + 3876 >> 2] | 0) + -1 + (e[g + 3880 >> 2] | 0) | 0) * a));
                n = (n | 0) > 8 ? 8 : n & 255
              } else n = 0;
              i[O >> 0] = n;
              v = W + -1 | 0;
              ...
              if ((v | 0) > 1) {
                ...
                while (1) {
                  ...
                  if (a > 0) {
                    ...
                    s = s < L ? L : s;
                    L = +r[S + (u << 2) >> 2];
                    n = ~~(((s < L ? L : s) * 3 - a) * 20 / (+((e[g + 3876 + (n << 2) >> 2] | 0) + -1 + (e[g + 3876 + (w << 2) >> 2] | 0) + (e[g + 3876 + (u << 2) >> 2] | 0) | 0) * a));
                    n = (n | 0) > 8 ? 8 : n & 255
                  } else n = 0;
                  i[O + w >> 0] = n;
                  a = m + h;
              ...
              if (a > 0) {
                s = +r[S + (n << 2) >> 2];
                m = +r[S + (u << 2) >> 2];
                n = ~~(((s < m ? m : s) * 2 - a) * 20 / (+((e[g + 3876 + (n << 2) >> 2] | 0) + -1 + (e[g + 3876 + (u << 2) >> 2] | 0) | 0) * a));
                n = (n | 0) > 8 ? 8 : n & 255
              } else n = 0;
              i[O + u >> 0] = n;
              if (X) {
                ...
                do {
                  ...
                  u = o[O + y >> 0] | 0;
                  _ = e[M >> 2] | 0;
                  a = +r[U + (D << 8) + (y << 2) >> 2] * +r[_ + (w << 2) >> 2] * +r[11488 + (u << 2) >> 2];
                  w = w + 1 | 0;
                  if ((y | 0) < (T | 0)) {
                    W = w;
                    v = y;
                    while (1) {
                      ...
                      A = o[O + v >> 0] | 0;
                      u = A + u | 0;
                      h = +r[U + (D << 8) + (v << 2) >> 2] * +r[_ + (W << 2) >> 2] * +r[11488 + (A << 2) >> 2];
                      A = v - n | 0;
                      a = a < 0 ? 0 : a;
                      h = h < 0 ? 0 : h;
                      do
                  ...
                  h = +r[11488 + (((u << 1 | 1 | 0) / (_ << 1 | 0) | 0) << 2) >> 2] * .5;
                  a = h * a;
                  u = K + (D << 8) + (n << 2) | 0;
                  r[u >> 2] = a;
                  X = E + 23612 + (D << 8) + (n << 2) | 0;
              ...
              n = 0;
              do {
                e[E + 24636 + (D << 8) + (n << 2) >> 2] = e[E + 23612 + (D << 8) + (n << 2) >> 2];
                n = n + 1 | 0
              } while ((n | 0) != (Le | 0))
            }
            D = D + 1 | 0
        ...
        if (!((e[ve >> 2] | 0) != 1 | R)) ur(U, K, re, (e[J >> 2] | 0) + 468 | 0, N, +r[be >> 2], e[me >> 2] | 0);
        if (ee) {
          n = 0;
          do {
      ...
      if (ee) {
        ...
        do {
          ...
          do {
            ...
            T = 0;
            do {
              h = +r[E + 25660 + (u * 244 | 0) + 88 + (n * 12 | 0) + (T << 2) >> 2] * .8;
              v = (T | 0) > 0;
              A = T + -1 | 0;
              s = +r[(v ? ie + (A << 2) | 0 : y) >> 2];
              _ = e[z + (u << 4) + (T << 2) >> 2] | 0;
              if ((_ | 0) <= 1 ? (e[z + (u << 4) + (T + 1 << 2) >> 2] | 0) != 1 : 0) m = h;
              else if (h > 0) m = +d(+(s / h), .36000001430511475) * h;
              else m = 0;
              m = m < h ? m : h;
              e: do
                if ((_ | 0) == 1)
                  if (m > 0) h = +d(+(s / m), .18000000715255737) * m;
                  else h = 0;
              else {
    ...
    function $r(M) {
      ...
      if ((a | 0) > 0) {
        ...
        do {
          ...
          P = f;
          f = A + f | 0;
          r[O + (o << 2) >> 2] = (+F(+(f + -1 | 0) * s) + w) * .5;
          w = +F((+(P | 0) + -.5) * u);
          r[N + (o << 2) >> 2] = +F((+(f | 0) + -.5) * u) - w;
          o = o + 1 | 0
        } while ((o | 0) != (a | 0));
        a = e[p >> 2] | 0;
        if ((a | 0) > 0) {
      ...
      if ((e[p >> 2] | 0) > 0) {
        ...
        do {
          ...
          if ((f | 0) > 0) {
            ...
            s = 1e37;
            do {
              w = +d(10, +((+L(R, +(a | 0) * b * 9.765625e-7 * 1e3) + -20) * .1));
              f = e[i >> 2] | 0;
              w = +(f | 0) * w;
              s = s > w ? w : s;
              o = o + 1 | 0;
          ...
          s = (+r[O + (E << 2) >> 2] * .10000000149011612 + -1) * 20;
          s = s > 6 ? 30 : s;
          r[B + (E << 2) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((s < u ? u : s) + -8) * .1));
          E = E + 1 | 0
        } while ((E | 0) < (e[p >> 2] | 0))
      }
      A = h + 2160 | 0;
      ...
      if ((a | 0) > 0) {
        ...
        if ((a | 0) > 0) {
          ...
          while (1) {
            u = +r[O + (_ << 2) >> 2];
            if (!(u >= 13)) s = -8.25;
            else s = (24 - u) * -.75 - (u + -13) * .40909090638160706;
            r[S + (_ << 2) >> 2] = +d(10, +(s * .1));
            B = T + (_ << 2) | 0;
            f = e[B >> 2] | 0;
            if ((f | 0) > 0) {
              ...
              s = 1e37;
              do {
                w = +d(10, +((+L(R, +(a | 0) * b * 390625e-11 * 1e3) + -20) * .1));
                f = e[B >> 2] | 0;
                w = +(f | 0) * w;
                s = s > w ? w : s;
                o = o + 1 | 0;
            ...
            s = (u * .0833333358168602 + -1) * 7;
            if (u > 12) s = (+Ve(+(s + 1)) * 3.1 + 1) * s;
            if (u < 12) s = (+Ve(+(1 - s)) * 2.3 + 1) * s;
            u = s > 6 ? 30 : s;
            r[E + (_ << 2) >> 2] = +(f | 0) * +d(10, +((e[D >> 2] | 0) < 44e3 ? 2.2 : ((u < m ? m : u) + -8) * .1));
            _ = _ + 1 | 0;
            a = e[C >> 2] | 0;
            if ((_ | 0) >= (a | 0)) break;
            else a = o
      ...
      S = e[f >> 2] | 0;
      r[S + 16 >> 2] = m;
      r[S + 8 >> 2] = .009999999776482582;
      r[S + 12 >> 2] = 1;
      if ((e[n + 208 >> 2] | 0) != -1) {
        u = +(e[D >> 2] | 0) * .0009765625;
        m = 0;
        s = 0;
        a = 0;
        do {
          s = s + u;
          w = 1 / +d(10, +(+L(R, s) * .10000000149011612));
          o = e[f >> 2] | 0;
          r[o + 724 + (a << 2) >> 2] = w;
          m = w + m;
          a = a + 1 | 0
      ...
      r[h + 6492 >> 2] = m < 0 ? 25 : m;
      o = e[M + 164 >> 2] | 0;
      if ((o | 0) < 4) s = -.7400000095367432;
      else {
        s = +r[11720 + (o << 2) >> 2];
        s = ((s - +r[11720 + (o + 1 << 2) >> 2]) * +r[M + 160 >> 2] + s) * .10000000149011612
      }
      if ((i | 0) > 0) {
        a = (i | 0) > 1;
        m = +(i | 0);
    ...
    function Te(s, o, n, i, w, v) {
      ...
      if ((n | 0) > 0) {
        ...
        while (1) {
          a = e[s + 1716 + (i << 2) >> 2] | 0;
          o = +F(+(((a | 0) / 2 | 0) + n | 0) * u);
          r[s + 768 + (i << 2) >> 2] = +d(10, +((1 - +N(+(o < 15.5 ? o * .2026833970057931 : 3.141592653589793))) * 1.25 + -2.5));
          i = i + 1 | 0;
      ...
      do {
        ...
        e[s + 1972 + (a << 2) >> 2] = ((e[_ + (((k | 0) < 0 ? 0 : k) << 2) >> 2] | 0) + l | 0) / 2 | 0;
        e[s + 2060 + (a << 2) >> 2] = l;
        o = +r[p + (l << 2) >> 2];
        ...
        r[s + 1112 + (a << 2) >> 2] = o;
        o = +F(+(n | 0) * S);
        r[s + 1024 + (a << 2) >> 2] = +d(10, +((1 - +N(+(o < 15.5 ? o * .2026833970057931 : 3.141592653589793))) * 1.25 + -2.5))
      } while ((i | 0) != (w | 0));
      t = E;
      return
    }
    ...
    function hr(w, h, u, f, s, i) {
      ...
      if (p) {
        ...
        do {
          ...
          do {
            ...
            if (!(o <= -60)) o = +v(+((o + d) * .23025850929940458)) * 1.5130440282194817;
            else o = 0;
      ...
      do {
        ...
        a = e[h + (s << 3) + 4 >> 2] | 0;
        if ((n | 0) <= (a | 0)) {
          l((e[w >> 2] | 0) + (i << 2) | 0, m + (s << 8) + (n << 2) | 0, a + 1 - n << 2 | 0) | 0;
          i = i + 1 + a - n | 0
        }
        s = s + 1 | 0
      } while ((s | 0) != (u | 0));
          ...
          do {
            ...
            if ((e[b >> 2] | 0) == 2) {
              ...
              do {
                ...
                E = +r[F >> 2];
                r[A >> 2] = (E + x) * .7071067690849304;
                r[F >> 2] = (x - E) * .7071067690849304;
                f = f + 1 | 0
              } while ((f | 0) != 576);
            ...
            if ((a | 0) > 0) {
              ...
              do {
                ...
                E = +v(+(3.5 - +r[m + (w << 3) + (i << 2) >> 2] * .0033333333333333335)) + 1;
                if ((e[n + 304 + (w * 10504 | 0) + (i * 5252 | 0) + 4788 >> 2] | 0) == 2) E = +r[_ >> 2] - (2.56 / E + -.14);
                else E = +r[u >> 2] - (1.28 / E + -.05);
                r[h >> 2] = +d(10, +(E * .1));
                Se(n, f);
                a = (J(n, k + (w * 976 | 0) + (i * 488 | 0) | 0, f, z + (w * 312 | 0) + (i * 156 | 0) | 0) | 0) == 0;
                o = a ? o : 0;
                e[U + (w << 3) + (i << 2) >> 2] = 126;
          ...
          while (1) {
            if (_) {
              ...
              while (1) {
                ...
                if ((e[n + 304 + (a * 10504 | 0) + (o * 5252 | 0) + 4788 >> 2] | 0) == 2 ? (W = e[n + 304 + (a * 10504 | 0) + (o * 5252 | 0) + 4852 >> 2] | 0, (W | 0) < 13) : 0) {
                  i = W;
                  while (1) {
                    E = +(i | 0);
                    E = E * E * .0001715976331360947 + 1;
                    m = f + 4 | 0;
                    r[f >> 2] = E * +r[f >> 2];
                    k = f + 8 | 0;
                    r[m >> 2] = E * +r[m >> 2];
          ...
          do {
            ...
            if (+r[O >> 2] > 9.999999682655225e-21) {
              ...
              if (i) {
                ...
                e[A >> 2] = p;
                if ((f | 0) == 2) l(n + 304 + (S * 10504 | 0) + (m * 5252 | 0) + 2304 | 0, F | 0, 2304) | 0;
                if (e[Y >> 2] & 1) kr(n, k, w, N);
                a = (e[h >> 2] | 0) + a + (e[n + 304 + (S * 10504 | 0) + (m * 5252 | 0) + 4844 >> 2] | 0) | 0
              }
        ...
        do {
          ...
          if ((e[u >> 2] | 0) == 2) {
            ...
            do {
              ...
              C = +r[f >> 2];
              r[a >> 2] = (C + B) * .7071067690849304;
              r[f >> 2] = (B - C) * .7071067690849304;
              h = h + 1 | 0
            } while ((h | 0) != 576)
          }
          a = e[_ >> 2] | 0;
          if ((a | 0) > 0) {
            ...
            do {
              ...
              r[x >> 2] = +d(10, +(+r[o >> 2] * .1));
              Se(i, a);
              a = (J(i, L + (m * 976 | 0) + (p * 488 | 0) | 0, a, N + (m * 312 | 0) + (p * 156 | 0) | 0) | 0) == 0;
              l = a ? l : 0;
        ...
        do {
          if ((o | 0) > 0) {
            ...
            do {
              ...
              c(F + (u * 4608 | 0) + (a * 2304 | 0) + (v << 2) | 0, 0, 576 - v << 2 | 0) | 0;
              H[e[h >> 2] & 7](i + 304 + (u * 10504 | 0) + (a * 5252 | 0) | 0, F + (u * 4608 | 0) + (a * 2304 | 0) | 0, v, b);
    ...
    function Yr(n, F, m, B) {
      ...
      e[S >> 2] = k;
      w = (11 - +r[n + 244 >> 2]) * .012727272727272728 + .93;
      w = w < .9 ? .8999999761581421 : w;
      U = (h | 0) > 0;
      if (U) {
        l = ~~((w > 1 ? 1 : w) * +(k | 0));
        f = (k | 0) / 2 | 0;
        ...
        do {
          if (L) {
            ...
            do {
              ...
              w = +r[F + (v << 3) + (i << 2) >> 2];
              if (w > 700) {
                o = ~~((w + -700) * .7142857142857143);
                o = ((o | 0) < (f | 0) ? (e[n + 304 + (v * 10504 | 0) + (i * 5252 | 0) + 4788 >> 2] | 0) == 2 : 0) ? f : o;
      ...
      if ((e[F >> 2] | 0) == 2)
        if (U) {
          ...
          if ((h | 0) > 1) {
            i = 1;
            do {
              ge(g + (i << 3) | 0, +r[m + (i << 2) >> 2], s(e[S >> 2] | 0, e[R >> 2] | 0) | 0, 7680);
              i = i + 1 | 0;
              h = e[O >> 2] | 0
            } while ((i | 0) < (h | 0));
            m = 17
            ...
            do {
              if ((e[F >> 2] | 0) == 2) {
                ...
                do {
                  ...
                  w = +r[E >> 2];
                  r[p >> 2] = (w + x) * .7071067690849304;
                  r[E >> 2] = (x - w) * .7071067690849304;
                  f = f + 1 | 0
                } while ((f | 0) != 576)
              }
              if ((e[R >> 2] | 0) > 0) {
                ...
                do {
                  ...
                  r[L >> 2] = +d(10, +(+r[((e[n + 304 + (a * 10504 | 0) + (i * 5252 | 0) + 4788 >> 2] | 0) == 2 ? h : _) >> 2] * .1));
                  Se(n, l);
                  r[S >> 2] = 0;
                  ...
                  if (+r[S >> 2] > 9.999999682655225e-21) {
                    ...
                    xe(n, l, I, C, i, o) | 0
                  } else c(n + 304 + (a * 10504 | 0) + (i * 5252 | 0) + 2304 | 0, 0, 2304) | 0;
                  Oe(n, a, i, z);
                  if ((e[k >> 2] | 0) == 1) oe(n, l);
                  le(n, l);
                  i = i + 1 | 0
      ...
      do {
        ...
        if ((e[A >> 2] | 0) == 2) {
          ...
          do {
            ...
            E = +r[u >> 2];
            r[o >> 2] = (E + b) * .7071067690849304;
            r[u >> 2] = (b - E) * .7071067690849304;
            a = a + 1 | 0
          } while ((a | 0) != 576);
        ...
        if ((e[y >> 2] | 0) > 0) {
          ...
          do {
            ...
            r[F >> 2] = +d(10, +(+r[((e[i + 304 + (n * 10504 | 0) + (o * 5252 | 0) + 4788 >> 2] | 0) == 2 ? O : R) >> 2] * .1));
            Se(i, s);
            r[_ >> 2] = 0;
    ...
    function Se(h, n) {
      ...
      do {
        o = s;
        s = s + 1 | 0;
        e[n + 4872 + (o << 2) >> 2] = (e[h + 21360 + (s << 2) >> 2] | 0) - (e[h + 21360 + (o << 2) >> 2] | 0);
        e[n + 5028 + (o << 2) >> 2] = 3
      } while ((s | 0) != 22);
      k = n + 4788 | 0;
      if ((e[k >> 2] | 0) == 2) {
      ...
      while (1) {
        ...
        e: while (1) {
          ...
          do {
            ...
            u = n + u | 0;
            if (!(+r[C + (E << 2) >> 2] < d)) {
              if (((e[$ >> 2] & 2 | 0) != 0 ? (R = v + 84936 + (E << 2) | 0, w = (e[R >> 2] | 0) == 0, e[R >> 2] = w & 1, !w) : 0) ? (e[W >> 2] | 0) == 2 : 0) {
                i = 2;
                break
              }
              w = h + 4608 + (E << 2) | 0;
          ...
          while (1) {
            if ((e[h + 4608 + (n << 2) >> 2] | 0) == (0 - (e[h + 4808 + (e[h + 5028 + (n << 2) >> 2] << 2) >> 2] | 0) | 0)) break;
            n = n + 1 | 0;
            if ((n | 0) >= (o | 0)) break e
          }
          if (We(v, h) | 0) {
            ...
            r: do
              if (!(e[x >> 2] | 0)) {
                ...
                while (1) {
                  if ((e[h + 4608 + (o << 2) >> 2] | 0) == (0 - (e[h + 4808 + (e[h + 5028 + (o << 2) >> 2] << 2) >> 2] | 0) | 0)) break r;
                  o = o + 1 | 0;
                  if ((o | 0) >= (i | 0)) {
                    _ = 167;
                    break e
          ...
          n = e[j >> 2] | 0;
          e[ie >> 2] = n;
          r: do switch (e[((e[Ee >> 2] | 0) == 2 ? Se : ve) >> 2] | 0) {
              case 1: {
                f = +r[V >> 2];
                _ = 118;
                break
              ...
              case 8: {
                if ((e[re >> 2] | 0) > 0) {
                  ...
                  do {
                    a = +r[C + (i << 2) >> 2];
                    f = +b(a * a * .632 * a + .368) * .30102999566398114 + f;
                    i = i + 1 | 0
                  } while ((i | 0) < (e[re >> 2] | 0))
                } else f = 1e-37;
              ...
              case 4: {
                ...
                do
                  if ((_ | 0) == 130) {
                    ...
                    if (d > 0) {
                      f = +r[q >> 2];
                      if (f > -.05 & f > a + -.1 ? +r[g >> 2] + +r[A >> 2] < +r[k >> 2] + +r[D >> 2] : 0) {
                        i = 1;
                        break
                      }
                      if (f > -.1 & f > a + -.15) i = +r[g >> 2] * 2 + +r[A >> 2] < +r[k >> 2] * 2 + +r[D >> 2];
                      else i = 0
                    } else i = 0
                  } while (0);
                i = i & 1;
    ...
    function zr(t) {
      ...
      do {
        ...
        if ((o | 0) < (l | 0))
          do {
            h = +L(w, +(o | 0) * i);
            s = +r[_ >> 2];
            s = +d(10, +((+r[p >> 2] + h + (s > 0 ? -s : -100)) * .10000000149011612));
            h = +r[a >> 2];
            r[a >> 2] = h < s ? h : s;
            o = o + 1 | 0
          } while ((o | 0) != (l | 0))
      ...
      do {
        ...
        if ((a | 0) < (f | 0)) {
          do {
            s = +L(w, +(a | 0) * m);
            i = +r[_ >> 2];
            i = +d(10, +((+r[p >> 2] + s + (i > 0 ? -i : -100)) * .10000000149011612));
            s = +r[u >> 2];
            i = s < i ? s : i;
            r[u >> 2] = i;
            a = a + 1 | 0
      ...
      m = +L(w, -1);
      i = +r[_ >> 2];
      i = +Mr(+d(10, +((+r[p >> 2] + m + (i > 0 ? -i : -100)) * .10000000149011612))) * 10;
      r[(e[E >> 2] | 0) + 20 >> 2] = i;
      r[3510] = 0;
      o = 1;
      do {
      ...
      do {
        m = i;
        i = +r[14040 + (o << 2) >> 2];
        r[46872 + (o << 2) >> 2] = +(o | 0) + -.5 - +d(+((i + m) * .5), .75);
        o = o + 1 | 0
      } while ((o | 0) != 8208);
      o = 0;
      do {
        r[79704 + (o << 2) >> 2] = +Or(+(o + -210 | 0) * -.1875);
        o = o + 1 | 0
      } while ((o | 0) != 257);
      o = 0;
      do {
        r[80736 + (o << 2) >> 2] = +Or(+(o + -326 | 0) * .25);
        o = o + 1 | 0
      } while ((o | 0) != 374);
      yi(t);
      Jr(t);
      c = t + 232 | 0;
      i = +d(10, +((+r[c >> 2] + -.5) * .10000000149011612));
      r[t + 84768 >> 2] = i;
      r[t + 84772 >> 2] = i;
      r[t + 84776 >> 2] = i;
      r[t + 84780 >> 2] = i;
      ...
      r[t + 84792 >> 2] = i;
      _ = t + 228 | 0;
      i = +d(10, +((+r[_ >> 2] + -.25) * .10000000149011612));
      r[t + 84796 >> 2] = i;
      r[t + 84800 >> 2] = i;
      r[t + 84804 >> 2] = i;
      r[t + 84808 >> 2] = i;
      ...
      r[t + 84820 >> 2] = i;
      p = t + 236 | 0;
      i = +d(10, +((+r[p >> 2] + -.02500000037252903) * .10000000149011612));
      r[t + 84824 >> 2] = i;
      r[t + 84828 >> 2] = i;
      r[t + 84832 >> 2] = i;
      r[t + 84836 >> 2] = i;
      ...
      r[t + 84848 >> 2] = i;
      w = t + 240 | 0;
      r[t + 84852 >> 2] = +d(10, +((+r[w >> 2] + .5) * .10000000149011612));
      i = +d(10, +((+r[c >> 2] + -2) * .10000000149011612));
      r[t + 84856 >> 2] = i;
      r[t + 84860 >> 2] = i;
      r[t + 84864 >> 2] = i;
      i = +d(10, +((+r[_ >> 2] + -1) * .10000000149011612));
      r[t + 84868 >> 2] = i;
      r[t + 84872 >> 2] = i;
      r[t + 84876 >> 2] = i;
      r[t + 84880 >> 2] = i;
      i = +d(10, +((+r[p >> 2] + -.05000000074505806) * .10000000149011612));
      r[t + 84884 >> 2] = i;
      r[t + 84888 >> 2] = i;
      r[t + 84892 >> 2] = i;
      r[t + 84896 >> 2] = i;
      r[t + 84900 >> 2] = i;
      r[t + 84904 >> 2] = +d(10, +((+r[w >> 2] + .5) * .10000000149011612));
      return
    }
    ...
    function ze(a, u, m, n, _, o) {
      ...
      do {
        ...
        i = (i | 0) > 4095 ? 4095 : i;
        e[m + (d << 2) >> 2] = i;
        n = ~~(+(i | 0) * +r[u + (_ << 3) + (d << 2) >> 2] * .0014285714285714286 - +(i | 0));
        n = (n | 0) > (E | 0) ? E : n;
        n = (n | 0) < 0 ? 0 : n;
        if ((n + i | 0) > 4095) {
          n = 4095 - i | 0;
    ...
    function ye(e, r, i, t) {
      ...
      if (e > 9.999999682655225e-21) e = +b(e) * .03333343265598758 + 1;
      else e = 0;
      return + +d(10, +((i + 90.30873107910156 + (t < 1 ? -94.82444763183594 : -t) + (e < 0 ? 0 : e) * r) * .10000000149011612))
    }
    ...
    function J(S, v, h, f) {
      ...
      if ((e[O >> 2] | 0) > 0) {
        ...
        while (1) {
          ...
          if (t > 9.999999682655225e-21) l = +b(t) * .03333343265598758 + 1;
          else l = 0;
          l = +d(10, +((c + 90.30873107910156 + (o < 1 ? -94.82444763183594 : -o) + (l < 0 ? 0 : l) * n) * .10000000149011612));
          M = +r[S + 84768 + (a << 2) >> 2];
          l = M * l;
          m = e[h + 4872 + (a << 2) >> 2] | 0;
          c = l / +(m | 0);
          ...
          t = o < l ? o : n < l ? l : n;
          l = +r[v + 244 + (a << 2) >> 2];
          if (l > 9.999999960041972e-13 ? (u = M * (+r[v + (a << 2) >> 2] * o / l), t < u) : 0) t = u;
      ...
      while (1) {
        ...
        if (o > 9.999999682655225e-21) n = +b(o) * .03333343265598758 + 1;
        else n = 0;
        u = +d(10, +((c + 90.30873107910156 + (l < 1 ? -94.82444763183594 : -l) + (n < 0 ? 0 : n) * t) * .10000000149011612));
        R = S + 84856 + (_ << 2) | 0;
        l = +r[R >> 2];
        u = l * u;
        k = e[h + 4872 + (m << 2) >> 2] | 0;
        ...
        if ((k | 0) > 0) {
          ...
          n = c < u ? c : n < u ? u : n;
          o = +r[v + 332 + (_ * 12 | 0) >> 2];
          if (o > 9.999999960041972e-13 ? (A = l * (+r[v + 88 + (_ * 12 | 0) >> 2] * c / o), n < A) : 0) n = A;
          ...
          if (o > 9.999999960041972e-13 ? (N = +r[R >> 2] * (+r[v + 88 + (_ * 12 | 0) + 4 >> 2] * c / o), n < N) : 0) n = N;
          o = n > 2.220446049250313e-16 ? n : 2.220446049250313e-16;
          ...
          if (n > 9.999999960041972e-13 ? (T = +r[R >> 2] * (+r[v + 88 + (_ * 12 | 0) + 8 >> 2] * o / n), l < T) : 0) l = T;
    ...
    function Fe(n, A, E, w, _) {
      ...
      while (1) {
        ...
        L = f - (i + (e[T >> 2] | 0) << (e[v >> 2] | 0) + 1) - (e[n + 4808 + (e[n + 5028 + (c << 2) >> 2] << 2) >> 2] << 3) | 0;
        T = T + 4 | 0;
        y = 1 / +r[A >> 2];
        A = A + 4 | 0;
        ...
        do
          if ((d | 0) == 8) {
            ...
            a = a * y;
            o = +b(a > 9.999999682655225e-21 ? a : 9.999999682655225e-21) * .30102999566398114;
            if (N) {
              r[_ + 320 + (c << 2) >> 2] = o;
              f = e[C >> 2] | 0;
              d = 27;
      ...
      do {
        if ((d | 0) > 0) {
          ...
          do {
            ...
            l(q | 0, z | 0, 156) | 0;
            if (re ? (V = u + 10808 + (i * 5252 | 0) + 4848 | 0, U = e[V >> 2] | 0, (U | 0) > 0) : 0) {
              d = U;
              a = 0;
              do {
            ...
            if ((I | 0) == 13) {
              ...
              do {
                ...
                n = +(a | 0);
                h = h / n;
                f[m + 190712 + (o * 704 | 0) + (i * 176 | 0) + (c << 3) >> 3] = h * 999999986991104;
                f[m + 201208 + (o * 352 | 0) + (i * 176 | 0) + (c << 3) >> 3] = +r[k + (c << 2) >> 2] * 999999986991104 * +r[O + (c << 2) >> 2] / n;
                n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 244 + (c << 2) >> 2];
                if (n > 0) h = (e[K >> 2] | 0) == 0 ? h / n : 0;
                else h = 0;
                n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + (c << 2) >> 2] * h;
                h = +r[P + 24 + (c << 2) >> 2];
                f[m + 189304 + (o * 704 | 0) + (i * 176 | 0) + (c << 3) >> 3] = (n > h ? n : h) * 999999986991104;
                ...
                if ((c | 0) < 21) f[a >> 3] = h - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (c << 2) >> 2] | 0) * R
              } while ((v | 0) != (d | 0))
            }
            if (y ? (x = e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4852 >> 2] | 0, (x | 0) < 13) : 0) {
              w = e[H >> 2] | 0;
              L = (e[K >> 2] | 0) == 0;
              ie = e[j >> 2] | 0;
              ...
              while (1) {
                ...
                C = (E | 0) < 12;
                if ((T | 0) <= (A | 0)) {
                  f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (g << 3) >> 3] = 9999999747378752e-21;
                  f[w + 201912 + (o * 624 | 0) + (i * 312 | 0) + (g << 3) >> 3] = +r[k + (d << 2) >> 2] * 999999986991104 * +r[O + (d << 2) >> 2] / D;
                  n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 332 + (E * 12 | 0) >> 2];
                  if (L ? (e[B >> 2] | 0) == 0 : 0) n = n > 0 ? 9.999999682655225e-21 / n : 0;
                  else n = 0;
                  n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 88 + (E * 12 | 0) >> 2] * n;
                  f[w + 192120 + (o * 1248 | 0) + (i * 312 | 0) + (g << 3) >> 3] = (n > b ? n : b) * 999999986991104;
                  n = +(e[te >> 2] | 0) * -2;
                  a = w + 199864 + (o * 624 | 0) + (i * 312 | 0) + (g << 3) | 0;
                  f[a >> 3] = n;
                  if (C) f[a >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (d << 2) >> 2] | 0) * R;
                  c = d + 1 | 0;
                  a = g + 1 | 0;
                  f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = 9999999747378752e-21;
                  f[w + 201912 + (o * 624 | 0) + (i * 312 | 0) + (a << 3) >> 3] = +r[k + (c << 2) >> 2] * 999999986991104 * +r[O + (c << 2) >> 2] / D;
                  n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 332 + (E * 12 | 0) + 4 >> 2];
                  if (L ? (e[B >> 2] | 0) == 0 : 0) n = n > 0 ? 9.999999682655225e-21 / n : 0;
                  else n = 0;
                  n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 88 + (E * 12 | 0) + 4 >> 2] * n;
                  f[w + 192120 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = (n > b ? n : b) * 999999986991104;
                  n = +(e[ne >> 2] | 0) * -2;
                  a = w + 199864 + (o * 624 | 0) + (i * 312 | 0) + (a << 3) | 0;
                  f[a >> 3] = n;
                  if (C) f[a >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (c << 2) >> 2] | 0) * R;
                  c = d + 2 | 0;
                  a = g + 2 | 0;
                  f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = 9999999747378752e-21;
                  f[w + 201912 + (o * 624 | 0) + (i * 312 | 0) + (a << 3) >> 3] = +r[k + (c << 2) >> 2] * 999999986991104 * +r[O + (c << 2) >> 2] / D;
                  ...
                  n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 88 + (E * 12 | 0) + 8 >> 2] * n;
                  f[w + 192120 + (o * 1248 | 0) + (i * 312 | 0) + (a << 3) >> 3] = (n > b ? n : b) * 999999986991104;
                  n = +(e[G >> 2] | 0) * -2;
                  a = w + 199864 + (o * 624 | 0) + (i * 312 | 0) + (a << 3) | 0;
                  f[a >> 3] = n;
                  ...
                  while (1) {
                    ...
                    c = a + g | 0;
                    f[w + 194616 + (o * 1248 | 0) + (i * 312 | 0) + (c << 3) >> 3] = n * 999999986991104;
                    f[w + 201912 + (o * 624 | 0) + (i * 312 | 0) + (c << 3) >> 3] = +r[k + (m << 2) >> 2] * 999999986991104 * +r[O + (m << 2) >> 2] / D;
                    h = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 332 + (E * 12 | 0) + (a << 2) >> 2];
                    if (L ? (e[B >> 2] | 0) == 0 : 0) n = h > 0 ? n / h : 0;
                    else n = 0;
                    n = +r[_ + (o * 976 | 0) + (i * 488 | 0) + 88 + (E * 12 | 0) + (a << 2) >> 2] * n;
                    f[w + 192120 + (o * 1248 | 0) + (i * 312 | 0) + (c << 3) >> 3] = (n > b ? n : b) * 999999986991104;
                    n = +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4808 + (a << 2) >> 2] | 0) * -2;
                    c = w + 199864 + (o * 624 | 0) + (i * 312 | 0) + (c << 3) | 0;
                    f[c >> 3] = n;
                    if (C) f[c >> 3] = n - +(e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4608 + (m << 2) >> 2] | 0) * R;
                    a = a + 1 | 0;
                    if ((a | 0) == 3) break;
                    else m = m + 1 | 0
                  }
            ...
            d = e[H >> 2] | 0;
            e[d + 201112 + (o << 3) + (i << 2) >> 2] = e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4780 >> 2];
            c = u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4844 | 0;
            e[d + 203400 + (o << 3) + (i << 2) >> 2] = (e[c >> 2] | 0) + (e[u + 304 + (o * 10504 | 0) + (i * 5252 | 0) + 4768 >> 2] | 0);
    ...
    function mr(l, a, p) {
      ...
      if (!r) {
        ...
        if ((s | 0) < (n | 0)) e[a + 4804 >> 2] = y[e[l + 85816 >> 2] & 3](a + 2304 + (s << 2) | 0, a + 2304 + (n << 2) | 0, u) | 0
      } else if ((r | 0) == 2) {
        r = (e[l + 21464 >> 2] | 0) * 3 | 0;
        r = (r | 0) > (n | 0) ? n : r;
        s = n
      ...
      r = (r | 0) < (n | 0) ? r : n;
      n = (s | 0) < (n | 0) ? s : n;
      if ((r | 0) > 0) e[a + 4796 >> 2] = y[e[l + 85816 >> 2] & 3](c, a + 2304 + (r << 2) | 0, u) | 0;
      if ((r | 0) < (n | 0)) e[a + 4800 >> 2] = y[e[l + 85816 >> 2] & 3](a + 2304 + (r << 2) | 0, a + 2304 + (n << 2) | 0, u) | 0;
      if ((e[l + 36 >> 2] | 0) == 2) {
        c = a + 4768 | 0;
        e[c >> 2] = e[u >> 2];
        oe(l, a);
    ...
    function oe(p, r) {
      ...
      if ((s | 0) > (c | 0)) {
        ...
        do {
          S = s;
          s = s + -4 | 0;
          S = (((e[r + 2304 + (s << 2) >> 2] << 1) + (e[r + 2304 + (S + -3 << 2) >> 2] | 0) << 1) + (e[r + 2304 + (S + -2 << 2) >> 2] | 0) << 1) + (e[r + 2304 + (S + -1 << 2) >> 2] | 0) | 0;
          n = (o[82240 + S >> 0] | 0) + n | 0;
          i = (o[82256 + S >> 0] | 0) + i | 0
        } while ((s | 0) > (c | 0));
        s = w + -2 - m | 0
      ...
      if (!(e[u + 4788 >> 2] | 0)) {
        ...
        n = e[p + 21392 >> 2] | 0;
        n = (n | 0) > (s | 0) ? s : n;
        if ((n | 0) > 0) e[u + 4796 >> 2] = y[e[p + 85816 >> 2] & 3](g, r + 2304 + (n << 2) | 0, i) | 0;
        if ((s | 0) > (n | 0)) e[u + 4800 >> 2] = y[e[p + 85816 >> 2] & 3](r + 2304 + (n << 2) | 0, r + 2304 + (s << 2) | 0, i) | 0;
    ...
    function I(y, k, f, w) {
      ...
      while (1) {
        if (!F ? (e[R >> 2] | 0) != 0 : 0) {
          ...
          n = (e[O >> 2] | 0) - (n + (e[f + 4608 + (d << 2) >> 2] | 0) << (e[A >> 2] | 0) + 1) - (e[f + 4808 + (e[f + 5028 + (d << 2) >> 2] << 2) >> 2] << 3) | 0;
        ...
        if ((a | 0) == 15) {
          ...
          l = m ? _ : l;
          o = m ? E : o;
          if ((S ? (m = e[L >> 2] | 0, !((m | 0) < 1 | (g | 0) < (m | 0))) : 0) ? (m = e[w + 8 + (g << 2) >> 2] | 0, !((m | 0) < 1 | (n | 0) < (m | 0))) : 0) {
            if (!u) {
              ne(t, p, o, l);
              l = _;
              o = E
      ...
      if ((e[y + 85096 >> 2] & 2 | 0) != 0 ? (P = .634521682242439 / +r[79704 + ((e[A >> 2] | 0) + (e[O >> 2] | 0) << 2) >> 2], T = f + 4860 | 0, v = e[T >> 2] | 0, (v | 0) > 0) : 0) {
        s = 0;
        t = 0;
        do {
          a = e[f + 4872 + (t << 2) >> 2] | 0;
    ...
    function Oe(g, d, n, t) {
      ...
      if ((f | 0) > 0) {
        ...
        do {
          ...
          e: do
            if ((r | 0) > 0)
              do {
                if (e[t + (d * 10504 | 0) + (n * 5252 | 0) + 2304 + (u << 2) >> 2] | 0) break e;
                u = u + 1 | 0
              } while ((u | 0) < (m | 0)); while (0);
          if ((u | 0) == (m | 0)) {
      ...
      e[h + 8 >> 2] = 0;
      e[h + 12 >> 2] = 0;
      if ((((d | 0) == 1 ? (e[g + 76 >> 2] | 0) == 2 : 0) ? (e[t + (n * 5252 | 0) + 4788 >> 2] | 0) != 2 : 0) ? (e[t + 10504 + (n * 5252 | 0) + 4788 >> 2] | 0) != 2 : 0) {
        o = e[21034] | 0;
        ...
        e: do
          if (a) {
            ...
            do {
              ...
              if ((h | 0) > -1 ? (e[t + (n * 5252 | 0) + 4608 + (r << 2) >> 2] | 0) != (h | 0) : 0) break e;
              r = r + 1 | 0
            } while ((r | 0) < (f | 0))
          } else r = o; while (0);
        if ((r | 0) == (f | 0)) {
          if (a) c(t + 10504 + (n * 5252 | 0) + 4608 + (o << 2) | 0, -1, f - o << 2 | 0) | 0;
          e[t + 21024 + (n << 4) >> 2] = 1
        }
        u = e[21036] | 0;
        o = (u | 0) > (f | 0);
        ...
        if ((r | 0) == (u | 0)) {
          if (o) c(t + 10504 + (n * 5252 | 0) + 4608 + (f << 2) | 0, -1, u - f << 2 | 0) | 0;
          e[t + 21024 + (n << 4) + 4 >> 2] = 1
        }
        f = e[21037] | 0;
        o = (f | 0) > (u | 0);
        ...
        if ((r | 0) == (f | 0)) {
          if (o) c(t + 10504 + (n * 5252 | 0) + 4608 + (u << 2) | 0, -1, f - u << 2 | 0) | 0;
          e[t + 21024 + (n << 4) + 8 >> 2] = 1
        }
        o = e[21038] | 0;
        a = (o | 0) > (f | 0);
        ...
        if ((r | 0) == (o | 0)) {
          if (a) c(t + 10504 + (n * 5252 | 0) + 4608 + (f << 2) | 0, -1, o - f << 2 | 0) | 0;
    ...
    function We(w, i) {
      ...
      if ((e[w + 76 >> 2] | 0) == 2) {
        ...
        r = 0;
        do {
          if (((u | 0) < (e[88776 + (r << 2) >> 2] | 0) ? (n | 0) < (e[88840 + (r << 2) >> 2] | 0) : 0) ? (_ = e[w + (r << 2) >> 2] | 0, (a | 0) > (_ | 0)) : 0) {
            e[f >> 2] = _;
            e[o >> 2] = r;
            a = _
          }
      ...
      d = ((r | 0) > (e[89096 + (m << 4) + 4 >> 2] | 0) & 1) + ((a | 0) > (e[89096 + (m << 4) >> 2] | 0) & 1) + ((o | 0) > (e[89096 + (m << 4) + 8 >> 2] | 0) & 1) + ((n | 0) > (e[89096 + (m << 4) + 12 >> 2] | 0) & 1) | 0;
      if (!d) {
    ...
    function yi(o) {
      ...
      do {
        r = 0;
        do r = r + 1 | 0; while ((e[o + 21360 + (r << 2) >> 2] | 0) < (n | 0));
        a = e[89256 + (r << 3) >> 2] | 0;
        t = a;
        while (1)
    ...
    function Fi(o, a, u) {
      ...
      do {
        ...
        l = o >>> 0 > 14;
        n = c >>> 0 > 14;
        r = (l ? t : 0) + r + (e[82816 + ((n ? 15 : c) + (l ? 240 : o << 4) << 2) >> 2] | 0) + (n ? t : 0) | 0
      } while (i >>> 0 < a >>> 0);
      o = r & 65535;
      a = r >>> 16;
      l = a >>> 0 > o >>> 0;
    ...
    function Ai(i, a, r, o) {
      ...
      r = 0;
      do {
        r = (e[n + ((s(e[i >> 2] | 0, t) | 0) + (e[i + 4 >> 2] | 0) << 2) >> 2] | 0) + r | 0;
        i = i + 8 | 0
      } while (i >>> 0 < a >>> 0);
      t = r & 65535;
      i = r >>> 16;
    ...
    function L(o, i) {
      ...
      switch (e[o + 192 >> 2] | 0) {
        case 3: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
          i = i < .10000000149011612 ? .10000000149011612 : i;
          i = i > 24 ? 24 : i;
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -.8) * 3.64 - +v(+(n * n * -.6)) * 6.8 + +v(+(t * t * -.15)) * 6 + +d(+i, 4) * .0006399999999999999 + 6;
          return +i
        }
        case 1: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -.8) * 3.64 - +v(+(n * n * -.6)) * 6.8 + +v(+(t * t * -.15)) * 6 + +d(+i, 4) * 56e-5;
          return +i
        }
        case 4: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -.8) * 3.64 - +v(+(n * n * -.6)) * 6.8 + +v(+(t * t * -.15)) * 6 + +d(+i, 4) * (+r[o + 188 >> 2] * 4e-5 + 6e-4);
          return +i
        }
        case 0: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -.8) * 3.64 - +v(+(n * n * -.6)) * 6.8 + +v(+(t * t * -.15)) * 6 + +d(+i, 4) * .0009599999999999999;
          return +i
        }
        case 5: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
        ...
        case 2: {
          ...
          n = i + -3.4;
          t = i + -8.7;
          i = +d(+i, -.8) * 3.64 - +v(+(n * n * -.6)) * 6.8 + +v(+(t * t * -.15)) * 6 + +d(+i, 4) * 6e-4;
          return +i
        }
        default: {
          i = i < -.3 ? 3.4100000858306885 : i * .0010000000474974513;
    ...
    function F(e) {
      e = +e;
      e = e < 0 ? 0 : e * .001;
      return +(+cr(+(e * e * .017777777777777778)) * 3.5 + +cr(+(e * .76)) * 13)
    }
    ...
    function pr(c, A, C, E, D, T) {
      ...
      H = c + 60 | 0;
      i = e[H >> 2] | 0;
      if ((i | 0) >= (~~(a * .9994999766349792) | 0) ? (~~(a * 1.000499963760376) | 0) >= (i | 0) : 0) {
        o = (L | 0) < (E | 0) ? L : E;
        i = o << 2;
        u = 0;
        do {
          ...
          if ((o | 0) < 0) {
            ...
            while (1) {
              ...
              while (1) {
                ...
                S = a + -.5;
                if (+p(+S) < 1e-9) a = Y;
                else a = (.42 - +N(+(a * 2 * 3.141592653589793)) * .5 + +N(+(a * 4 * 3.141592653589793)) * .08) * +Lr(+(F * S)) / (G * S);
                r[n + (h << 2) >> 2] = a;
                d = a + d;
                if ((h | 0) < (s | 0)) h = h + 1 | 0;
                else break
        ...
        e: do
          if (W) {
            ...
            do {
              ...
              h = t - b | 0;
              i = e[c + 37192 + (~~+x(+(S * (d - y - +(t | 0)) + M + .5)) << 2) >> 2] | 0;
              w = 0;
              d = 0;
              while (1) {
                O = w + h | 0;
                d = +r[i + (w << 2) >> 2] * +r[((O | 0) < 0 ? g + (O + _ << 2) | 0 : P + (O << 2) | 0) >> 2] + d;
                if ((w | 0) < (s | 0)) w = w + 1 | 0;
                else break
              }
              r[K + (o + B << 2) >> 2] = d;
    ...
    function Zi() {
      ...
      do {
        r[89648 + (i << 2) >> 2] = +Ve(+(+(i | 0) * .001953125 + 1)) * 1.4426950408889634;
        i = i + 1 | 0
      } while ((i | 0) != 513);
      e[22410] = 1;
      return
    ...
    function b(i) {
      ...
      o = t >>> 14 & 511;
      return +(+r[89648 + (o << 2) >> 2] * (1 - i) + +((t >>> 23 & 255) + -127 | 0) + +r[89648 + (o + 1 << 2) >> 2] * i)
    }
    ...
    function ct(t, a, n) {
      ...
      i = 0;
      do {
        r = ((r & 65535) >>> 8 ^ e[48 + (((r ^ (o[a + i >> 0] | 0)) & 255) << 2) >> 2]) & 65535;
        S[t >> 1] = r;
        i = i + 1 | 0
      } while ((i | 0) != (n | 0));
      return
    ...
    function ee(i) {
      ...
      return ((s((t * 72e3 | 0) + 72e3 | 0, e[r >> 2] | 0) | 0) / (e[i + 64 >> 2] | 0) | 0) + (e[i + 84752 >> 2] | 0) << 3 | 0
    }
    ...
    function Dr(i, n) {
      ...
      if ((n | 0) == 1) {
        t = e[i + 48 >> 2] | 0;
        r = ((s((r * 72e3 | 0) + 72e3 | 0, e[((t | 0) < 16e3 ? 83944 + (r << 6) + 32 | 0 : 83944 + (r << 6) + 56 | 0) >> 2] | 0) | 0) / (t | 0) | 0) << 3;
        return r | 0
      } else if ((n | 0) == 2) {
        r = (r * 7680 | 0) + 7680 | 0;
        return r | 0
    ...
    function pt(r) {
      ...
      i = (((s((i * 72e3 | 0) + 72e3 | 0, e[n >> 2] | 0) | 0) / (e[r + 64 >> 2] | 0) | 0) + (e[r + 84752 >> 2] | 0) << 3) + a | 0;
      if ((i | 0) < 0) {
        M(r, 1072, f);
        t = f;
        return
    ...
    function Et(u) {
      ...
      q = u + 84752 | 0;
      j = u + 64 | 0;
      W = ((s((m * 72e3 | 0) + 72e3 | 0, e[r >> 2] | 0) | 0) / (e[j >> 2] | 0) | 0) + (e[q >> 2] | 0) << 3;
      K = u + 21320 | 0;
      Re(u, e[K >> 2] | 0);
      w = u + 52128 | 0;
      r = e[w >> 2] | 0;
      ...
      do
        if ((e[A >> 2] | 0) != 1) {
          ...
          if ((f | 0) > 0) {
            p = 0;
            while (1) {
              d = (e[u + 304 + (p * 5252 | 0) + 4844 >> 2] | 0) + (e[u + 304 + (p * 5252 | 0) + 4768 >> 2] | 0) | 0;
              a = 12;
              do {
                h = 8 - (n & 7) | 0;
                f = (a | 0) < (h | 0) ? a : h;
          ...
          do {
            if ((n | 0) > 0) {
              ...
              m = 0;
              while (1) {
                d = (e[u + 304 + (p * 10504 | 0) + (m * 5252 | 0) + 4844 >> 2] | 0) + (e[u + 304 + (p * 10504 | 0) + (m * 5252 | 0) + 4768 >> 2] | 0) | 0;
                a = 12;
                do {
                  h = 8 - (n & 7) | 0;
                  f = (a | 0) < (h | 0) ? a : h;
        ...
        if ((e[A >> 2] | 0) == 1) {
            ...
            if ((d | 0) > 0) {
              ...
              do {
                ...
                e: do
                  if ((r | 0) > 0) {
                    if ((R | 0) > 0) {
                      ...
                      a = 0;
                      while (1) {
                        d = ((e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4608 + (a << 2) >> 2] | 0) == -1 ? 0 : R) + d | 0;
                        a = a + 1 | 0;
                        if ((a | 0) == (r | 0)) break e
                      }
                    }
                    do {
                      E = e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4608 + (r << 2) >> 2] | 0;
                      if ((E | 0) != -1) {
                        _ = R;
                        do {
                          a = e[P >> 2] | 0;
                          if (!a) {
                            ...
                            if ((e[u + 39840 + (m * 48 | 0) >> 2] | 0) == (e[k >> 2] | 0)) {
                              l((e[T >> 2] | 0) + a | 0, u + 39840 + (m * 48 | 0) + 8 | 0, e[N >> 2] | 0) | 0;
                              f = e[N >> 2] | 0;
                              a = (e[v >> 2] | 0) + f | 0;
                              e[v >> 2] = a;
                              e[k >> 2] = (e[k >> 2] | 0) + (f << 3);
                ...
                if ((e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4788 >> 2] | 0) == 2) {
                  ...
                  a = e[f >> 2] | 0;
                  h = (h | 0) > (a | 0) ? a : h;
                  a = O(u, e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4796 >> 2] | 0, 0, h, F) | 0;
                  a = (O(u, e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4800 >> 2] | 0, h, e[f >> 2] | 0, F) | 0) + a | 0
                } else {
                  a = e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4772 >> 2] | 0;
                  f = e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4824 >> 2] | 0;
                  y = e[u + 21360 + (f + 1 << 2) >> 2] | 0;
                  f = e[u + 21360 + (f + 2 + (e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4828 >> 2] | 0) << 2) >> 2] | 0;
                  y = (y | 0) > (a | 0) ? a : y;
                  f = (f | 0) > (a | 0) ? a : f;
                  h = O(u, e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4796 >> 2] | 0, 0, y, F) | 0;
                  h = (O(u, e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4800 >> 2] | 0, y, f, F) | 0) + h | 0;
                  a = h + (O(u, e[u + 304 + (b * 10504 | 0) + (S * 5252 | 0) + 4804 >> 2] | 0, f, a, F) | 0) | 0
                }
                n = d + n + a + (lr(u, F) | 0) | 0;
                S = S + 1 | 0;
                d = e[I >> 2] | 0
          ...
          do {
            ...
            if ((e[u + 304 + (A * 5252 | 0) + 4788 >> 2] | 0) == 2) {
                      ...
                      do {
                        ...
                        if (!E) {
                          ...
                          if ((e[u + 39840 + (_ * 48 | 0) >> 2] | 0) == (e[k >> 2] | 0)) {
                            l((e[f >> 2] | 0) + E | 0, u + 39840 + (_ * 48 | 0) + 8 | 0, e[N >> 2] | 0) | 0;
                            v = e[N >> 2] | 0;
                            E = (e[h >> 2] | 0) + v | 0;
                            e[h >> 2] = E;
                            e[k >> 2] = (e[k >> 2] | 0) + (v << 3);
                      ...
                      do {
                        ...
                        if (!E) {
                          ...
                          if ((e[u + 39840 + (v * 48 | 0) >> 2] | 0) == (_ | 0)) {
                            l((e[f >> 2] | 0) + E | 0, u + 39840 + (v * 48 | 0) + 8 | 0, e[N >> 2] | 0) | 0;
                            v = e[N >> 2] | 0;
                            E = (e[h >> 2] | 0) + v | 0;
                            e[h >> 2] = E;
                            e[k >> 2] = (e[k >> 2] | 0) + (v << 3);
                      ...
                      do {
                        ...
                        if (!_) {
                          ...
                          if ((e[u + 39840 + (E * 48 | 0) >> 2] | 0) == (v | 0)) {
                            l((e[f >> 2] | 0) + _ | 0, u + 39840 + (E * 48 | 0) + 8 | 0, e[N >> 2] | 0) | 0;
                            v = e[N >> 2] | 0;
                            _ = (e[h >> 2] | 0) + v | 0;
                            e[h >> 2] = _;
                            e[k >> 2] = (e[k >> 2] | 0) + (v << 3);
              ...
              d = (O(u, e[u + 304 + (A * 5252 | 0) + 4800 >> 2] | 0, F, e[b >> 2] | 0, H) | 0) + d | 0
            } else {
              a = 0;
              d = 0;
              g = 0;
                    ...
                    while (1) {
                      ...
                      do {
                        ...
                        if (!r) {
                          ...
                          m = e[p >> 2] | 0;
                          if ((e[u + 39840 + (m * 48 | 0) >> 2] | 0) == (e[k >> 2] | 0)) {
                            l((e[f >> 2] | 0) + r | 0, u + 39840 + (m * 48 | 0) + 8 | 0, e[N >> 2] | 0) | 0;
                            F = e[N >> 2] | 0;
                            r = (e[h >> 2] | 0) + F | 0;
                            e[h >> 2] = r;
                            e[k >> 2] = (e[k >> 2] | 0) + (F << 3);
              ...
              b = e[u + 21360 + (b + 2 + (e[u + 304 + (A * 5252 | 0) + 4828 >> 2] | 0) << 2) >> 2] | 0;
              S = (S | 0) > (d | 0) ? d : S;
              b = (b | 0) > (d | 0) ? d : b;
      ...
      m = (((s((r * 72e3 | 0) + 72e3 | 0, e[n >> 2] | 0) | 0) / (e[j >> 2] | 0) | 0) + (e[q >> 2] | 0) << 3) + m | 0;
      if ((m | 0) < 0) M(u, 1072, G);
      n = u + 52140 | 0;
      if ((m | 0) != (e[n >> 2] | 0)) {
        M(u, 1168, Q);
    ...
    function $(i, w, a, f) {
      ...
      while (1) {
        ...
        if ((a | 0) > 0) {
          ...
          if ((e[E >> 2] | 0) != 0 ? (Ye(e[_ >> 2] | 0, h | 0, s | 0, a | 0, e[o >> 2] | 0) | 0) == 0 : 0) {
            s = 24;
            break
          }
        }
          ...
          while (1) {
            ...
            if (!r) {
              ...
              if ((e[u + 39840 + (t * 48 | 0) >> 2] | 0) == (a | 0)) {
                l((e[m >> 2] | 0) + r | 0, u + 39840 + (t * 48 | 0) + 8 | 0, e[_ >> 2] | 0) | 0;
                n = e[_ >> 2] | 0;
                r = (e[f >> 2] | 0) + n | 0;
                e[f >> 2] = r;
                e[c >> 2] = (e[c >> 2] | 0) + (n << 3);
                  ...
                  do {
                    ...
                    do {
                      ...
                      if (!t) {
                        ...
                        a = e[h >> 2] | 0;
                        if ((e[u + 39840 + (a * 48 | 0) >> 2] | 0) == (e[c >> 2] | 0)) {
                          l((e[m >> 2] | 0) + t | 0, u + 39840 + (a * 48 | 0) + 8 | 0, e[_ >> 2] | 0) | 0;
                          a = e[_ >> 2] | 0;
                          t = (e[f >> 2] | 0) + a | 0;
                          e[f >> 2] = t;
                          e[c >> 2] = (e[c >> 2] | 0) + (a << 3);
          ...
          do {
            ...
            if (!n) {
              ...
              if ((e[c + 39840 + (t * 48 | 0) >> 2] | 0) == (e[h >> 2] | 0)) {
                l((e[v >> 2] | 0) + n | 0, c + 39840 + (t * 48 | 0) + 8 | 0, e[y >> 2] | 0) | 0;
                t = e[y >> 2] | 0;
                n = (e[m >> 2] | 0) + t | 0;
                e[m >> 2] = n;
                e[h >> 2] = (e[h >> 2] | 0) + (t << 3);
          ...
          do {
            ...
            if (!t) {
              ...
              if ((e[c + 39840 + (n * 48 | 0) >> 2] | 0) == (e[h >> 2] | 0)) {
                l((e[v >> 2] | 0) + t | 0, c + 39840 + (n * 48 | 0) + 8 | 0, e[y >> 2] | 0) | 0;
                n = e[y >> 2] | 0;
                t = (e[m >> 2] | 0) + n | 0;
                e[m >> 2] = t;
                e[h >> 2] = (e[h >> 2] | 0) + (n << 3);
          ...
          do {
            ...
            if (!t) {
              ...
              if ((e[s + 39840 + (a * 48 | 0) >> 2] | 0) == (e[h >> 2] | 0)) {
                l((e[E >> 2] | 0) + t | 0, s + 39840 + (a * 48 | 0) + 8 | 0, e[b >> 2] | 0) | 0;
                a = e[b >> 2] | 0;
                t = (e[d >> 2] | 0) + a | 0;
                e[d >> 2] = t;
                e[h >> 2] = (e[h >> 2] | 0) + (a << 3);
    ...
    function sr(a, g, A, G, Y) {
      ...
      e: do
        if ((o | 0) > 0) {
          ...
          while (1) {
            ...
            if (ei(a, P, u, x, L, b + (u << 3) | 0, E + (u << 3) | 0, D + (u << 4) | 0, y) | 0) {
              u = -4;
              break
            }
            if ((e[m >> 2] | 0) == 1 ? (U = +r[D + (u << 4) + 12 >> 2], C = U + +r[D + (u << 4) + 8 >> 2], B = q + (u << 2) | 0, r[B >> 2] = C, C > 0) : 0) r[B >> 2] = U / C;
            o = e[w >> 2] | 0;
            if ((o | 0) > 0) {
              i = 0;
              do {
                e[a + 304 + (u * 10504 | 0) + (i * 5252 | 0) + 4788 >> 2] = e[y + (i << 2) >> 2];
      ...
      do
        if (!(e[a + 80 >> 2] | 0))
          if ((e[a + 180 >> 2] | 0) == 1) {
            ...
            M = d + -1 | 0;
            if ((e[a + 5092 >> 2] | 0) == (e[a + 10344 >> 2] | 0) ? (e[a + 304 + (M * 10504 | 0) + 4788 >> 2] | 0) == (e[a + 304 + (M * 10504 | 0) + 10040 >> 2] | 0) : 0) {
              e[y >> 2] = 2;
              o = 1
            } else o = 0
          } else o = 0;
      ...
      m = o ? E : b;
      D = a + 140 | 0;
      if (((e[D >> 2] | 0) != 0 ? (p = a + 85804 | 0, (e[p >> 2] | 0) != 0) : 0) ? (h = e[S >> 2] | 0, (h | 0) > 0) : 0) {
        d = a + 72 | 0;
        o = e[d >> 2] | 0;
        i = 0;
        do {
          if ((o | 0) > 0) {
            ...
            do {
              ...
              f[E + 90904 + (i << 3) >> 3] = 0;
              f[E + 90920 + (i << 3) >> 3] = _;
              e[E + 203288 + (i << 3) + (h << 2) >> 2] = e[a + 304 + (i * 10504 | 0) + (h * 5252 | 0) + 4788 >> 2];
              f[E + 189240 + (i << 5) + (h << 3) >> 3] = +r[m + (i << 3) + (h << 2) >> 2];
              l(E + 54040 + (i * 9216 | 0) + (h * 4608 | 0) | 0, a + 304 + (i * 10504 | 0) + (h * 5252 | 0) | 0, 2304) | 0;
              if ((e[y >> 2] | 0) == 2) {
                E = h + 2 | 0;
                b = e[p >> 2] | 0;
                f[b + 197144 + (i << 5) + (h << 3) >> 3] = +f[b + 197144 + (i << 5) + (E << 3) >> 3];
                l(b + 123704 + (i << 15) + (h << 13) | 0, b + 123704 + (i << 15) + (E << 13) | 0, 8192) | 0
              }
              h = h + 1 | 0;
              o = e[d >> 2] | 0
            } while ((h | 0) < (o | 0));
      ...
      if ((p | 0) == 3 | (p | 0) == 0) {
        ...
        r[i >> 2] = O;
        _ = +(s(u * 3350 | 0, g) | 0) / ((U + C) * .9354900121688843 + ((Z + ie) * .7568249702453613 + ((se + J) * .5045499801635742 + ((Q + ee) * .23387250304222107 + ((re + R) * 3.8980449615198e-17 + ((X + te) * -.1559150069952011 + ((ne + oe) * -.21623599529266357 + ((ae + _) * -.18920649588108063 + ((O + v) * -.10394349694252014 + F)))))))));
        if (d & (g | 0) > 0) {
          o = 0;
          do {
            h = 0;
      ...
      if ((e[D >> 2] | 0) != 0 ? (z = e[a + 85804 >> 2] | 0, (z | 0) != 0) : 0) {
        ...
        if ((i | 0) > 0) {
          ...
          do {
            w = 0;
            do {
              f[z + 24 + (o * 12800 | 0) + (w << 3) >> 3] = +f[z + 24 + (o * 12800 | 0) + (w + d << 3) >> 3];
              w = w + 1 | 0
            } while ((w | 0) != 272);
            w = e[I + (o << 2) >> 2] | 0;
            m = 272;
      ...
      do {
        if ((w | 0) > 0) {
          m = 0;
          do {
            w = (e[a + 304 + (o * 10504 | 0) + (m * 5252 | 0) + 4792 >> 2] | 0) == 0 ? e[a + 304 + (o * 10504 | 0) + (m * 5252 | 0) + 4788 >> 2] | 0 : 4;
    ...
    function Ot(t) {
      ...
      do {
        n = +(i | 0) + .5;
        r[2360 + (i << 2) >> 2] = .42 - +N(+(n * .006135923151542565)) * .5 + +N(+(n * .01227184630308513)) * .08;
        i = i + 1 | 0
      } while ((i | 0) != 1024);
      i = 0;
      do {
        r[1848 + (i << 2) >> 2] = (1 - +N(+((+(i | 0) + .5) * .02454369260617026))) * .5;
        i = i + 1 | 0
      } while ((i | 0) != 128);
      e[t + 85820 >> 2] = 1;
      return
    ...
    function or(u, p, d) {
      ...
      if (!(f >>> 0 > 30 | h >>> 0 > 30 | o >>> 0 > 30 | l >>> 0 > 30) ? (r & 10 | 0) == 0 & (l >>> 0 < 29 | (e[_ + 85720 >> 2] | 0) == 0) : 0) {
        u = 0;
        t = v;
        return u | 0
      }
        ...
        while (1) {
          ...
          do
            if ((u | 0) == 1431520594 | (u | 0) == 1129270605) {
              ...
              s = f + 32 | 0;
              m = f + 28 | 0;
              o = (e[m >> 2] << ((e[s >> 2] | 0) == 1 & 1)) + ((e[h >> 2] | 0) == 1 ? (o << 1) + 16 | 0 : o + 15 | 0) | 0;
              if (o >>> 0 > 10) {
                i[d + 3 >> 0] = u;
                i[d + 2 >> 0] = u >>> 8;
                i[d + 1 >> 0] = u >>> 16;
      ...
      if ((k | 0) != 0 ? (M = e[F >> 2] | 0, g = e[_ + 85732 >> 2] | 0, (M | 0) != 0 & (g | 0) != 0) : 0) {
        i[a + 3 >> 0] = 67;
        i[a + 2 >> 0] = 73;
        i[a + 1 >> 0] = 80;
        i[a >> 0] = 65;
    ...
    function Pt(r, a, u, d, w) {
      ...
      e: do
        ...
        while (0);
        e: do
          if ((a | 0) == 1347570006 | (a | 0) == 1196575044 | (a | 0) == 1162756946 | (a | 0) == 1279872587 | (a | 0) == 1095061059 | (a | 0) == 1346588244 | (a | 0) == 1195724610 | (a | 0) == 1095780675 | (a | 0) == 1398361172 | (a | 0) == 1129270605 | (a | 0) == 1465407576 | (a | 0) == 1415075928)
            if (!r) f = 25;
            else {
              if (!d) r: while (1) {
    ...
    function tr(n, r) {
      ...
      o = q(i[n >> 0] | 0) | 0;
      e = q(e << 24 >> 24) | 0;
      if ((((e & 255) << 24 >> 24 < 32 ? 32 : e) ^ ((o & 255) << 24 >> 24 < 32 ? 32 : o)) & 255) return 0;
      e = q(i[n + 1 >> 0] | 0) | 0;
      t = q(t << 24 >> 24) | 0;
      if (!((((t & 255) << 24 >> 24 < 32 ? 32 : t) ^ ((e & 255) << 24 >> 24 < 32 ? 32 : e)) & 255)) {
        e = q(i[n + 2 >> 0] | 0) | 0;
        r = q(r << 24 >> 24) | 0;
        return ((((r & 255) << 24 >> 24 < 32 ? 32 : r) ^ ((e & 255) << 24 >> 24 < 32 ? 32 : e)) & 255 | 0) == 0 | 0
      } else return 0;
      return 0
    }
    ...
    function At(f) {
        ...
        if (!i) {
          ...
          if ((y | 0) == 4 | (y | 0) == 1) {
            ...
            while (1) {
              ...
              if (((a | 0) >= (u | 0) ? (x = +r[6560 + (m * 24 | 0) + 4 >> 2], x <= F) : 0) ? (U = +r[6560 + (m * 24 | 0) + 8 >> 2], F < U) : 0) {
                E = x;
                l = U;
                break
              }
      ...
      if (!a) {
        ...
        if ((e[B >> 2] | 0) == 3 ? (y = e[M >> 2] | 0, (y | 0) == 3 | (y | 0) == 0) : 0) l = l * 1.5;
        a = ~~l;
        e[h >> 2] = a;
        i = e[T >> 2] | 0
      }
      if (!i) {
        ...
        do
          if ((a | 0) != -1) {
            i = (a | 0) < 3971 ? 8e3 : (a | 0) < 4511 ? 11025 : (a | 0) < 5421 ? 12e3 : (a | 0) < 7231 ? 16e3 : (a | 0) < 9971 ? 22050 : (a | 0) < 11221 ? 24e3 : (a | 0) < 15251 ? 32e3 : (a | 0) < 15961 ? 44100 : i;
            if ((i | 0) > (u | 0))
              if ((u | 0) <= 44100)
                if ((u | 0) <= 32e3)
                  if ((u | 0) > 24e3) i = 32e3;
      ...
      e[o + 84760 >> 2] = 576;
      i = e[M >> 2] | 0;
      if ((i | 0) == 4 | (i | 0) == 2 | (i | 0) == 1) e[f + 100 >> 2] = e[7056 + (e[f + 164 >> 2] << 2) >> 2];
      else if ((i | 0) == 3) {
        _ = +(s(u << 4, e[v >> 2] | 0) | 0);
        r[f + 100 >> 2] = _ / (+(e[f + 168 >> 2] | 0) * 1e3)
      } else {
      ...
      if ((h | 0) > 0 ? (h | 0) < ((u | 0) / 2 | 0 | 0) : 0) {
        ...
        if (_ > 0) {
          ...
          i = 999;
          do {
            F = +(m | 0) * .03225806451612903;
            a = (a | 0) < (m | 0) | !(F >= l) ? a : m;
            i = F < l & _ < F ? (i | 0) < (m | 0) ? i : m : i;
            m = m + 1 | 0
          } while ((m | 0) != 32);
          r[T >> 2] = (+(((i | 0) == 999 ? a : i) | 0) + -.75) * .03225806451612903;
          r[w >> 2] = +(a | 0) * .03225806451612903
        }
      }
      h = o + 260 | 0;
      u = o + 256 | 0;
      if (E > 0 & E < .021774193548387097) {
        r[u >> 2] = 0;
        r[h >> 2] = 0;
        Vi(o, 7096, R);
        E = +r[h >> 2]
      ...
      do
        if (E > 0) {
          ...
          a = -1;
          do {
            _ = +(m | 0) * .03225806451612903;
            i = (i | 0) > (m | 0) | !(_ <= l) ? i : m;
            a = l < _ & _ < E ? (a | 0) > (m | 0) ? a : m : a;
            m = m + 1 | 0
          } while ((m | 0) != 32);
          l = +(i | 0);
          r[u >> 2] = l * .03225806451612903;
          if ((a | 0) == -1) {
            E = (l + .75) * .03225806451612903;
            r[h >> 2] = E;
            i = 0;
            break
          } else {
            E = (+(a | 0) + .75) * .03225806451612903;
            r[h >> 2] = E;
            i = 0;
            break
          }
      ...
      l = +r[f + 228 >> 2];
      r[o + 196 >> 2] = -l;
      r[o + 200 >> 2] = +d(10, +(l * -.10000000149011612));
      e[o + 204 >> 2] = u;
      e[o + 208 >> 2] = S;
      e[o + 212 >> 2] = e[f + 208 >> 2];
      e[o + 216 >> 2] = e[f + 212 >> 2];
      ...
      e[o + 96 >> 2] = M & 2;
      l = +(M >>> 2 & 63 | 0);
      r[o + 232 >> 2] = (!(l >= 32) ? l : l + -64) * .25;
      l = +(M >>> 8 & 63 | 0);
      r[o + 228 >> 2] = (!(l >= 32) ? l : l + -64) * .25;
      l = +(M >>> 14 & 63 | 0);
      l = !(l >= 32) ? l : l + -64;
      r[o + 236 >> 2] = l * .25;
      _ = +(M >>> 20 & 63 | 0);
      r[o + 240 >> 2] = ((!(_ >= 32) ? _ : _ + -64) + l) * .25;
      l = +r[f + 20 >> 2];
      _ = +r[f + 24 >> 2] * l;
      l = +r[f + 28 >> 2] * l;
      do
                ...
                if (!S) {
                  ...
                  r: while (1) {
                    while (1) {
                      ...
                      e[C >> 2] = i;
                      pr(n, v, T, l, O, y);
                      if (((e[L >> 2] | 0) != 0 ? (e[f >> 2] | 0) == 0 : 0) ? (S = e[E >> 2] | 0, (Ye(e[P >> 2] | 0, (e[v >> 2] | 0) + (S << 2) | 0, (e[A >> 2] | 0) + (S << 2) | 0, e[y >> 2] | 0, e[F >> 2] | 0) | 0) == 0) : 0) {
                        o = -6;
                        break e
                      }
                      a = e[O >> 2] | 0;
                  ...
                  r: while (1) {
                    do {
                      ...
                      e[C >> 2] = i;
                      pr(n, v, T, l, O, y);
                      if (((e[L >> 2] | 0) != 0 ? (e[f >> 2] | 0) == 0 : 0) ? (d = e[E >> 2] | 0, (Ye(e[P >> 2] | 0, (e[v >> 2] | 0) + (d << 2) | 0, (e[A >> 2] | 0) + (d << 2) | 0, e[y >> 2] | 0, e[F >> 2] | 0) | 0) == 0) : 0) {
                        o = -6;
                        break e
                      }
                      a = e[O >> 2] | 0;
    ...
    function mt(i) {
      ...
      do
        if (e[i + 128 >> 2] | 0) {
          ...
          else if (!(t <= .024600999937888446)) n = 5;
          else n = 6;
          if ((n | 0) == 5) {
            e[i + 85688 >> 2] = ~~+x(+(s * 10 + .5));
            break
          } else if ((n | 0) == 6) {
            e[i + 85688 >> 2] = 0;
            break
    ...
    function Ge(s, i, J) {
      ...
      while (1) {
        if ((e[B >> 2] | 0) > 0) {
                ...
                if (!(a < 1e-12)) {
                  ...
                  if ((O | 0) == 2) {
                    ...
                    do {
                      ...
                      N = (8 - i << 5) + n | 0;
                      k = i * 3 | 0;
                      r[c + (k + 9 << 2) >> 2] = +r[s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + (M << 2) >> 2] * a - +r[s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + (N << 2) >> 2];
                      T = s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + ((14 - i << 5) + n << 2) | 0;
                      R = s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + (u + R << 2) | 0;
                      r[c + (k + 18 << 2) >> 2] = +r[T >> 2] * a + +r[R >> 2];
                      r[c + (k + 10 << 2) >> 2] = +r[R >> 2] * a - +r[T >> 2];
                      T = s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + ((2 - i << 5) + n << 2) | 0;
                      A = s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + ((A << 5) + n << 2) | 0;
                      r[c + (k + 19 << 2) >> 2] = +r[T >> 2] * a + +r[A >> 2];
                      r[c + (k + 11 << 2) >> 2] = +r[A >> 2] * a - +r[T >> 2];
                      r[c + (k + 20 << 2) >> 2] = +r[s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + (N << 2) >> 2] * a + +r[s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + (M << 2) >> 2];
                      i = i + 1 | 0
                    } while ((i | 0) != 0);
                    o = c;
                    u = 0;
                    while (1) {
                      ...
                      N = o + 60 | 0;
                      v = +r[N >> 2];
                      g = a * .13165250420570374 - v;
                      m = +r[o >> 2];
                      n = o + 36 | 0;
                      d = +r[n >> 2];
                      S = m * .7673270106315613 - d;
                      a = v * .13165250420570374 + a;
                      m = d * .7673270106315613 + m;
                      d = m + a;
                      M = o + 12 | 0;
                      v = +r[M >> 2];
                      i = o + 48 | 0;
                      E = +r[i >> 2];
                      _ = S + g;
                      p = (v * .4142135679721832 - E) * 2.069978111953089e-11;
                      r[o >> 2] = p + _ * 1.90752519173728e-11;
                      v = (E * .4142135679721832 + v) * 2.069978111953089e-11;
                    ...
                    do {
                      ...
                      M = (u << 5) + n | 0;
                      k = (8 - o << 5) + n | 0;
                      d = +r[s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + (k << 2) >> 2] * +r[7336 + (O * 144 | 0) + (o + 36 << 2) >> 2] + +r[s + 27824 + (f * 4608 | 0) + (h * 2304 | 0) + (M << 2) >> 2] * +r[7336 + (O * 144 | 0) + (o + 27 << 2) >> 2];
                      i = o + 18 | 0;
                      a = +r[s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + (M << 2) >> 2] * +r[7336 + (O * 144 | 0) + (u << 2) >> 2] - +r[s + 27824 + (f * 4608 | 0) + (b * 2304 | 0) + (k << 2) >> 2] * +r[7336 + (O * 144 | 0) + (i << 2) >> 2];
                      p = +r[7624 + (o + 12 << 2) >> 2];
                      r[w + (u << 2) >> 2] = d - a * p;
                      r[w + (i << 2) >> 2] = p * d + a;
                      o = o + 1 | 0
                    ...
                    r[c + 68 >> 2] = +r[C >> 2] - m + _;
                    _ = _ * .5 + (m - +r[C >> 2]);
                    a = (S - E - g) * .8660253882408142;
                    r[c + 20 >> 2] = _ + a;
                    r[c + 24 >> 2] = a - _;
                    _ = (+r[Q >> 2] - +r[Z >> 2]) * .8660253882408142;
                    m = +r[C >> 2] + m * .5;
                    a = E * .6427876353263855 + S * .9848077297210693 + g * .3420201539993286 + _;
                    y = v * .7660444378852844 + d * .1736481785774231 + p * .9396926164627075 + m;
                    r[c + 4 >> 2] = a + y;
                    r[c + 8 >> 2] = a - y;
                    y = S * .6427876353263855 - E * .3420201539993286 + g * .9848077297210693 - _;
                    a = d * .7660444378852844 - v * .9396926164627075 - p * .1736481785774231 + m;
                    r[c + 36 >> 2] = y + a;
                    r[c + 40 >> 2] = y - a;
                    _ = E * .9848077297210693 + S * .3420201539993286 - g * .6427876353263855 - _;
                    m = d * .9396926164627075 - v * .1736481785774231 + p * .7660444378852844 - m;
                    r[c + 52 >> 2] = m + _;
                    r[c + 56 >> 2] = _ - m;
                    m = +r[K >> 2] - +r[w >> 2];
                    _ = +r[X >> 2] - +r[x >> 2];
                    ...
                    r[c >> 2] = +r[L >> 2] + d + E;
                    E = -d - +r[L >> 2] + E * .5;
                    a = (m - _ + p) * .8660253882408142;
                    r[c + 44 >> 2] = E + a;
                    r[c + 48 >> 2] = E - a;
                    a = (+r[H >> 2] - +r[z >> 2]) * .8660253882408142;
                    d = +r[L >> 2] - d * .5;
                    E = v * .9396926164627075 - g * .1736481785774231 - S * .7660444378852844 - d;
                    y = _ * .9848077297210693 + m * .3420201539993286 + p * .6427876353263855 + a;
                    r[c + 12 >> 2] = E + y;
                    r[c + 16 >> 2] = E - y;
                    y = v * .7660444378852844 - g * .9396926164627075 + S * .1736481785774231 + d;
                    E = m * .6427876353263855 - _ * .3420201539993286 - p * .9848077297210693 + a;
                    r[c + 28 >> 2] = y + E;
                    r[c + 32 >> 2] = y - E;
                    d = g * .7660444378852844 + v * .1736481785774231 - S * .9396926164627075 + d;
                    a = _ * .6427876353263855 + m * .9848077297210693 - p * .3420201539993286 - a;
                    r[c + 60 >> 2] = d + a;
                    r[c + 64 >> 2] = d - a;
                    break
                  }
          ...
          if ((i | 0) == 1) l(s + 27824 + (f * 4608 | 0) | 0, s + 27824 + (f * 4608 | 0) + 2304 | 0, 2304) | 0
        }
        f = f + 1 | 0;
    ...
    function Ke(s, n) {
      ...
      while (1) {
        ...
        b = +r[d + 16 >> 2];
        v = +r[d + 20 >> 2];
        a = +r[h + 640 >> 2] * y + +r[h + 896 >> 2] * m + +r[h + 384 >> 2] * o + +r[h + 128 >> 2] * w + +r[h + -128 >> 2] * l + +r[h + -384 >> 2] * _ + +r[h + -640 >> 2] * c + +r[h + -896 >> 2] * k - +r[p + 1024 >> 2] * t - +r[p + 768 >> 2] * i - +r[p + 512 >> 2] * u - +r[p + 256 >> 2] * e - +r[p >> 2] * S - +r[p + -256 >> 2] * f - +r[p + -512 >> 2] * b - +r[p + -768 >> 2] * v;
        v = (+r[p + -640 >> 2] * y + +r[p + -896 >> 2] * m + +r[p + -384 >> 2] * o + +r[p + -128 >> 2] * w + +r[p + 128 >> 2] * l + +r[p + 384 >> 2] * _ + +r[p + 640 >> 2] * c + +r[p + 896 >> 2] * k + +r[h + -1024 >> 2] * t + +r[h + -768 >> 2] * i + +r[h + -512 >> 2] * u + +r[h + -256 >> 2] * e + +r[h >> 2] * S + +r[h + 256 >> 2] * f + +r[h + 512 >> 2] * b + +r[h + 768 >> 2] * v) * +r[d + 24 >> 2];
        F = g << 1;
        r[n + (F + 30 << 2) >> 2] = a + v;
      ...
      i = (+r[s + -252 >> 2] - +r[s + 4 >> 2]) * 5302.158203125 + +r[s + -124 >> 2] * 10612.802734375 + (+r[s + 132 >> 2] + +r[s + -380 >> 2]) * 929.7763061523438 + (+r[s + -508 >> 2] - +r[s + 260 >> 2]) * 728.8010864257812 + (+r[s + 388 >> 2] + +r[s + -636 >> 2]) * 288.09765625 + (+r[s + -764 >> 2] - +r[s + 516 >> 2]) * 64.91738891601562 + (+r[s + 644 >> 2] + +r[s + -892 >> 2]) * 30.125003814697266 + (+r[s + -1020 >> 2] - +r[s + 772 >> 2]) * 4.101456642150879;
      o = +r[s + -444 >> 2] * 1945.5516357421875 + +r[s + -188 >> 2] * 12804.7978515625 + +r[s + -700 >> 2] * 313.42449951171875 + +r[s + -956 >> 2] * 20.801593780517578 - +r[s + 68 >> 2] * 1995.1556396484375 - +r[s + 324 >> 2] * 9.000839233398438 - +r[s + 580 >> 2] * -29.202180862426758 - +r[s + 836 >> 2];
      e = o - i;
      i = o + i;
      O = n + 56 | 0;
      o = +r[O >> 2];
      ...
      w = +r[V >> 2];
      m = w + t;
      w = (t - w) * .7653668522834778;
      G = n + 76 | 0;
      t = +r[G >> 2];
      z = n + 44 | 0;
      _ = +r[z >> 2];
      f = _ + t;
      _ = (t - _) * .7653668522834778;
      Y = n + 64 | 0;
      t = +r[Y >> 2];
      W = n + 48 | 0;
      E = +r[W >> 2];
      i = E + t;
      E = (t - E) * .39018064737319946;
      j = n + 68 | 0;
      t = +r[j >> 2];
      F = n + 52 | 0;
      l = +r[F >> 2];
      u = l + t;
      l = (t - l) * .39018064737319946;
      t = +r[x >> 2];
      r[X >> 2] = t + o;
      r[x >> 2] = (t - o) * .7653668522834778;
      o = +r[B >> 2];
      r[Z >> 2] = o + a;
      r[B >> 2] = (o - a) * .7653668522834778;
      a = +r[M >> 2];
      r[M >> 2] = e + a;
      r[q >> 2] = (a - e) * .7653668522834778;
      e = +r[D >> 2];
      r[D >> 2] = c + e;
      r[K >> 2] = (e - c) * .7653668522834778;
      c = +r[n >> 2];
      r[n >> 2] = i + c;
    ...
    function Q(r, d, m, s, u, f, a, _) {
      ...
      b = 0 - d | 0;
      e: do
        if ((u | 0) != 0 | (s | 0) != 1 ? (i = r + (0 - (e[_ + (f << 2) >> 2] | 0)) | 0, (g[m & 1](i, r) | 0) >= 1) : 0) {
          c = i;
          n = u;
          i = 1;
          o = s;
    ...
    function Or(i) {
      ...
      do
        if (a >>> 0 > 1083174911) {
          if (((o | 0) > -1 | (o | 0) == -1 & (e[n >> 2] | 0) >>> 0 > 4294967295) & a >>> 0 > 1083179007) {
      ...
      i = +ji(u + u * i * (i * (i * (i * (i * .0013333559164630223 + .009618129842126066) + .0555041086648214) + .2402265069591) + .6931471805599453), (o & -256 | 0) / 256 | 0);
      t = s;
      return +i
    }
    ...
    function Mr(r) {
      ...
      e[n + 4 >> 2] = a;
      c = +f[n >> 3];
      r = l * (r + (t * (t * (t * .15313837699209373 + .22222198432149784) + .3999999999940942) + u * (t * (t * (t * .14798198605116586 + .1818357216161805) + .2857142874366239) + .6666666666666735))) + (o - c - r);
      o = c * .4342944818781689;
      t = +(s + (i >>> 20) | 0);
      u = t * .30102999566361177;
      l = u + o;
      r = l + (o + (u - l) + (r * .4342944818781689 + (t * 3.694239077158931e-13 + (c + r) * 2.5082946711645275e-11)));
      return +r
    }
              ...
              do
                if (b >>> 0 < 2146435072 | (b | 0) == 2146435072 & 0 < 0) {
                  ...
                  if ((b | 0) == 97) {
                    ...
                    v = (A | 0) != 0 & (cr + l | 0) < (A | 0) ? dr + A - H | 0 : lr - H + l | 0;
                    w = v + P | 0;
                    p = x & 73728;
                    u = (I | 0) > (w | 0);
                    if ((p | 0) == 0 & u) {
                        ...
                        while (1) {
                          ...
                          do
                            if (a >>> 0 < w >>> 0) {
                              ...
                              e[w >> 2] = p;
                              w = w + 4 | 0
                            } else a = (e[a >> 2] | 0) == 0 ? a + 4 | 0 : a; while (0);
                  ...
                  if ((u | 0) < (((w - B >> 2) * 9 | 0) + -9 | 0)) {
                    ...
                    do
                      if ((k | 0) == 221) {
                        k = 0;
                        X = (((u >>> 0) / (v >>> 0) | 0) & 1 | 0) == 0 ? 9007199254740992 : 9007199254740994;
                        p = (v | 0) / 2 | 0;
                        do
                          if (d >>> 0 < p >>> 0) F = .5;
                          else {
                            if ((d | 0) == (p | 0) ? (Z + (A + -1022 << 2) | 0) == (w | 0) : 0) {
                              F = 1;
                              break
                            }
                            F = 1.5
    ...
    function W(n) {
      ...
      n = e[24232] | 0;
      if ((n | 0) != 0 ? (M = e[24230] | 0, k = M + b | 0, k >>> 0 <= M >>> 0 | k >>> 0 > n >>> 0) : 0) {
        t = 0;
        return t | 0
      }
      e: do
        if (!(e[24233] & 4)) {
          ...
          r: do
            if (n) {
              ...
              while (1) {
                f = e[r >> 2] | 0;
                if (f >>> 0 <= n >>> 0 ? (I = r + 4 | 0, (f + (e[I >> 2] | 0) | 0) >>> 0 > n >>> 0) : 0) {
                  o = r;
                  n = I;
                  break
                }
          ...
          r: do
            if ((t | 0) == 184) {
              o = 0 - f | 0;
              do
                if (S >>> 0 > f >>> 0 & (f >>> 0 < 2147483647 & (r | 0) != (-1 | 0)) ? (_ = e[24242] | 0, _ = d - f + _ & 0 - _, _ >>> 0 < 2147483647) : 0)
                  if ((B(_ | 0) | 0) == (-1 | 0)) {
                    B(o | 0) | 0;
                    break r
                  } else {
      ...
      while (0);
      if ((((t | 0) == 191 ? b >>> 0 < 2147483647 : 0) ? (h = B(b | 0) | 0, A = B(0) | 0, h >>> 0 < A >>> 0 & ((h | 0) != (-1 | 0) & (A | 0) != (-1 | 0))) : 0) ? (D = A - h | 0, L = D >>> 0 > (E + 40 | 0) >>> 0, L) : 0) {
        n = L ? D : n;
        t = 194
      }
      if ((t | 0) == 194) {
        ...
        e: do
          if (m) {
            ...
            if (((t | 0) == 204 ? (e[z + 12 >> 2] & 8 | 0) == 0 : 0) ? m >>> 0 < h >>> 0 & m >>> 0 >= x >>> 0 : 0) {
              e[U >> 2] = H + n;
              t = (e[24125] | 0) + n | 0;
              _ = m + 8 | 0;
              _ = (_ & 7 | 0) == 0 ? 0 : 0 - _ & 7;
            ...
            while (1) {
              r = e[o >> 2] | 0;
              if (r >>> 0 <= m >>> 0 ? (i = e[o + 4 >> 2] | 0, s = r + i | 0, s >>> 0 > m >>> 0) : 0) break;
              o = e[o + 8 >> 2] | 0
            }
            f = r + (i + -39) | 0;
    ...
    function wi(e, r) {
      ...
      r = r >>> 16;
      e = s(r, o) | 0;
      return (m = (i >>> 16) + (s(r, n) | 0) + (((i & 65535) + e | 0) >>> 16) | 0, i + e << 16 | t & 65535 | 0) | 0
    }
    ...
    function Me(f, c, d, w, n) {
      ...
      if (!a) {
        ...
        do {
          ...
          w = s >> 31 | ((s | 0) < 0 ? -1 : 0) << 1;
          t = w & 1;
          l = R(h, p, w & r, (((s | 0) < 0 ? -1 : 0) >> 31 | ((s | 0) < 0 ? -1 : 0) << 1) & i) | 0;
          o = m;
          a = a - 1 | 0
        } while ((a | 0) != 0);
        i = d;
  ...
  Encoder.prototype.encode = function(i) {
    ...
    var t = lame_encode_buffer_ieee_float(this.gfp, this.srcPtr[0], this.srcPtr[1], r, this.dstPtr, this.dstSz);
  ...
  Encoder.prototype.finish = function(e) {
    ...
    var i = new Blob(this.mp3Buffers, {
      type: e || "audio/mpeg"
    });
    this.cleanup();
    return i
