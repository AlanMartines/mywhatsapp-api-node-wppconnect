        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2: return [4 /*yield*/, lookpath_1.lookpath('ffmpeg', {
                        include: [
                            'C:\\FFmpeg\\bin',
                            'C:\\FFmpeg\\FFmpeg\\bin',
...
function convertToMP4GIF(inputBase64) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    inputPath = path.join(tmpDir.name, "" + i++);
                    outputPath = path.join(tmpDir.name, i++ + ".mp4");
                ...
                case 2:
                    _a.trys.push([2, , 4, 5]);
                    return [4 /*yield*/, execa_1.default(ffmpegPath, [
                            '-i',
                            inputPath,
                            '-movflags',
                            'faststart',
                ...
                case 3:
                    ...
                    throw out.stderr;
                case 4:
                    rimraf_1.default(inputPath, function () { return null; });
                    rimraf_1.default(outputPath, function () { return null; });
                    return [7 /*endfinally*/];
