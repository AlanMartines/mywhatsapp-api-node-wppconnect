...
import { CatchQRCallback, CreateOptions, StatusFindCallback } from '../api/model/initializer';
 ...
 */
export declare function create(sessionName: string, catchQR?: CatchQRCallback, statusFind?: StatusFindCallback, options?: CreateConfig, browserSessionToken?: SessionToken): Promise<Whatsapp>;
