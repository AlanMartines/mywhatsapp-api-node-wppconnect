        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, latest_version_1.default('@wppconnect-team/wppconnect')
...
function logUpdateAvailable(current, latest) {
    // prettier-ignore
    var newVersionLog = "There is a new version of " + chalk_1.default.bold("Wppconnect") + " " + chalk_1.default.gray(current) + " \u279C  " + chalk_1.default.bold.green(latest) + "\n" +
        "Update your package by running:\n\n" +
        (chalk_1.default.bold('\>') + " " + chalk_1.default.blueBright('npm update @wppconnect-team/wppconnect'));
    logger_1.defaultLogger.info(boxen_1.default(newVersionLog, { padding: 1 }));
    logger_1.defaultLogger.info("For more info visit: " + chalk_1.default.underline('https://github.com/wppconnect-team/wppconnect/blob/master/Update.md') + "\n");
}
