        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [3 /*break*/, 4];
                case 1: return [4 /*yield*/, sharp_1.default(_B, { failOnError: false })
                        .resize({ width: 512, height: 512 })
                        .toBuffer()];
                case 2:
                    _ins = _c.sent();
                    _w = sharp_1.default(_ins, { failOnError: false }).webp();
                    return [3 /*break*/, 5];
                case 3:
                    _w = sharp_1.default(_B, { animated: true }).webp();
                    return [3 /*break*/, 5];
                case 4:
...
function resizeImg(buff, size) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sharp_1.default(buff, { failOnError: false })
