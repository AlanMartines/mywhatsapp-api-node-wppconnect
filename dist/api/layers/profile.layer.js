...
var ProfileLayer = /** @class */ (function (_super) {
    ...
    ProfileLayer.prototype.sendMute = function (id, time, type) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, helpers_1.evaluateAndReturn(this.page, function (id, time, type) { return WAPI.sendMute(id, time, type); }, id, time, type)];
                    case 1:
                        result = _a.sent();
                        if (result['erro'] == true) {
                            throw result;
    ...
    ProfileLayer.prototype.setTheme = function (type) {
        return helpers_1.evaluateAndReturn(this.page, function (type) { return WAPI.setTheme(type); }, type);
    };
    /**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, helpers_1.resizeImg(buff, { width: 96, height: 96 })];
                    case 4:
                        _webb64_96 = _a.sent();
                        return [4 /*yield*/, helpers_1.resizeImg(buff, { width: 640, height: 640 })];
                    case 5:
                        _webb64_640 = _a.sent();
